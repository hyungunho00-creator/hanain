#!/usr/bin/env python3
"""Insert 12 cancer-treatment-care action-intent posts (Batch 2) to Supabase."""
import json
import os
...
OUT_DIR = "/home/user/webapp/tmp_seo_assets/cancer_care_batch2"
os.makedirs(OUT_DIR, exist_ok=True)

print(f"[INSERT] {len(POSTS)} cancer-treatment-care Batch 2 posts → Supabase")
