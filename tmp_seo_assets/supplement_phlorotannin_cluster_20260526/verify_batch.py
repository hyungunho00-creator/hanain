...
INSIGHT_SLUGS = [
    "supplement-stack-checklist-phlorotannin-omega3-vitamin-d",
    "phlorotannin-supplement-clinical-evidence-map-2026",
]
KEY = (
...
def main():
    ...
    for slug in INSIGHT_SLUGS:
        ...
        try:
            st, _, html = fetch(url, headers={"User-Agent": "Googlebot"})
            results["insights"].append({
                "slug": slug,
                "status": st,
                "html_has_bundle": "/assets/" in html,
            })
        except Exception as exc:
