#!/usr/bin/env python3
"""Insert 15 cancer-treatment-care + hospital-info posts (Batch 3) to Supabase."""
import json
import os
...
OUT_DIR = "/home/user/webapp/tmp_seo_assets/cancer_care_batch3"
os.makedirs(OUT_DIR, exist_ok=True)

print(f"[INSERT] {len(POSTS)} cancer-treatment-care Batch 3 posts → Supabase")
