# -*- coding: utf-8 -*-
"""
Supabase posts 테이블에 10개 SEO 글 v2(L1-L4 플랫폼화 키워드)를 INSERT.
- v1과 동일 패턴: VITE_SUPABASE_ANON_KEY 사용, Content-Profile: public 헤더
- import만 posts_data_v2 로 교체
- v2 배치: L1 4 + L2 2 + L3 2 + L4 2 = 10건
"""
import os
import sys
import json
...
from posts_data_batch_b import POSTS  # noqa: E402
...
def insert_post(post):
    ...
    payload = {
        ...
        "status": "published",
        # og_image: 생략 → api/seo.js의 /og-image.png fallback 사용
    }
...
def main():
    print(f"=== Supabase posts INSERT (Batch B: 40-expansion 2/4) ===")
