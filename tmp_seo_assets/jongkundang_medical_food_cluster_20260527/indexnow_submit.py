# -*- coding: utf-8 -*-
"""Submit the Jongkundang medical-food URLs to IndexNow endpoints."""
...
def main():
    ...
    urls += [f"{SITE}/blog?category=diabetes", f"{SITE}/blog?category=cancer-treatment-care", f"{SITE}/blog?category=buying-guide", f"{SITE}/sitemap.xml"]
