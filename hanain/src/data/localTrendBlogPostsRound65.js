...
const posts = [
  {
    ...
    consumerPoint:
      '소비자가 실제로 궁금해하는 것은 “치즈를 조금 먹었는데 괜찮을까요?”입니다. 답은 먹은 양보다 고위험군 여부, 먹은 날짜, 증상 시작 시점, 냉장고 보관 상태, 같이 먹은 가족, 임신 여부, 면역저하 약물 사용 여부를 함께 봐야 합니다. 리스테리아 증상은 노출 뒤 같은 날부터 수 주 뒤까지 나타날 수 있어, 오늘 배가 괜찮다고 모든 기록을 지워 버리면 상담이 어려워집니다. 파트너 글은 공포를 키우기보다 “구입일, 제품 사진, 제조자 번호, 먹은 사람, 증상 달력, 냉장고 청소 여부”를 손에 쥐게 만들어야 전화 문의로 이어집니다.',
    records: [
