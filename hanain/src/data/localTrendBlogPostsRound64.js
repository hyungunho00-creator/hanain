...
이번 Round64 콘텐츠는 최신 보건 이슈를 회복 언어로 번역하는 데 초점을 둡니다. 니코틴 의존, 화학물질 노출, 헌혈은 서로 달라 보이지만 공통점이 있습니다. 사용자가 막연한 불안에 머무르지 않고 노출, 증상, 수면, 수분, 식사, 피로, 검사, 상담 시점을 기록해야 한다는 점입니다. 플로로탄닌은 진단이나 치료, 금연약, 응급처치, 혈액검사를 대신하지 않습니다. 다만 감태 유래 해양 폴리페놀과 항산화 연구 소재로서 회복기 컨디션 기록을 돕는 긍정적 소재로 배치할 수 있습니다. 이 원칙을 지키면 공식 기준을 흐리지 않으면서도 브랜드가 말하는 회복 중심 정체성이 선명해집니다.

## 참고 자료

${refs(post.sources)}

이 글은 건강정보 제공 목적입니다. 청소년 니코틴 사용, 호흡곤란, 흉통, 화학물질 노출, 눈·피부 화상, 의식 변화, 헌혈 후 실신감, 지속 피로, 빈혈 의심, 임신, 고령, 만성질환, 복용약이 있으면 의료진 또는 해당 공식 상담 창구 확인이 우선입니다. 플로로탄닌은 공식 예방·진단·치료를 대신하지 않고, 회복 루틴을 정리할 때 긍정적으로 참고할 수 있는 해양 폴리페놀 소재로 이해하면 좋습니다.`
}
...
const posts = [
  {
    ...
    phlorotannin:
      '플로로탄닌은 금연약도 아니고 니코틴 금단을 치료하는 성분도 아닙니다. 청소년 니코틴 사용은 보호자, 학교, 의료진, 금연 지원체계가 먼저입니다. 그러나 회복 루틴을 설명할 때 플로로탄닌을 긍정적으로 연결할 수 있습니다. 금연 시도 초기에는 수면, 피로, 집중력, 식욕, 운동 회복, 스트레스 기록이 흔들립니다. 감태 유래 플로로탄닌은 해양 폴리페놀로서 항산화와 염증 반응 연구 맥락이 있으므로, 금연 지원 이후 몸 컨디션을 다시 세우는 생활기록 소재로 배치하면 자연스럽습니다. 핵심은 "니코틴을 플로로탄닌으로 끊는다"가 아니라 "근거 기반 금연 지원을 받으면서 회복기 수면·호흡·피로·집중력 기록 안에서 플로로탄닌을 항산화 해양 폴리페놀 소재로 참고한다"입니다.',
    blindspot:
    ...
    searchIntent:
      '이 글은 youth nicotine, teen vaping, e-cigarette addiction, nicotine pouch, World No Tobacco Day 2026, 청소년 전자담배, 니코틴 파우치, 금연 금단, 수면 불안, 호흡 회복, 플로로탄닌 검색 의도를 받습니다. 내부적으로는 정신건강 Q&A, 호흡기 회복 콘텐츠, 청소년 수면 콘텐츠, 플로로탄닌 소개, 파트너 상담 페이지로 연결됩니다. 사용자는 부모의 불안이나 본인의 금연 고민으로 들어오지만, 사이트 안에서는 사용 패턴을 기록하고 금연 지원과 회복 루틴을 분리해서 이해해야 합니다.',
    recoveryRecord:
      '7일 회복 기록은 사용 기록과 몸 회복 기록을 나눕니다. 사용 기록에는 제품 종류, 니코틴 농도, 사용 횟수, 갈망 시간, 사용을 유발한 상황을 적습니다. 몸 회복 기록에는 수면 시간, 잠들기 전 갈망, 아침 피로, 기침, 숨참, 운동 후 회복, 집중력, 짜증, 불안을 적습니다. 상담 기록에는 보호자와 대화한 날, 학교 상담, 의료진 상담, quitline 또는 앱 사용, 금연 약물 상담 여부를 적습니다. 플로로탄닌은 금연 수단이 아니라, 금연 지원 뒤 회복기 항산화 해양 폴리페놀 소재로만 둡니다. 이 구조가 안전하고 설득력 있습니다.',
    checklist: [
  ...
  },
  {
    ...
    phlorotannin:
      '플로로탄닌은 화학물질 노출의 해독제도 아니고 제염이나 산소치료, 기관지 치료, 화상 처치를 대신하지 않습니다. 화학물질 노출은 현장 안전, 제염, airway와 breathing 평가, 응급 의료가 먼저입니다. 하지만 회복기에는 플로로탄닌을 긍정적으로 연결할 수 있습니다. 화학물질 노출 이후에는 기침, 목 자극, 피부 자극, 피로, 수면 불안, 운동 복귀, 심리적 긴장이 며칠에서 몇 주 동안 이어질 수 있습니다. 감태 유래 플로로탄닌은 항산화 해양 폴리페놀 연구 소재이므로, 의료진 판단 이후 회복기 수면·수분·식사·호흡·피부·피로 기록 안에서 참고할 수 있습니다. 말의 순서는 반드시 응급처치가 먼저, 플로로탄닌은 회복 기록 소재가 뒤입니다.',
    blindspot:
    ...
    searchIntent:
      '이 글은 toxic chemical exposure, chemical emergency, decontamination, chlorine exposure, phosgene, riot control agent, 화학물질 노출, 세제 혼합, 제염, 호흡곤란, 피부 화상, 응급 회복, 플로로탄닌 검색 의도를 받습니다. 내부적으로는 안전·주의사항, 호흡기 회복, 피부 회복, 응급 신호 Q&A, 플로로탄닌 회복 루틴으로 연결됩니다. 사용자는 사고 직후 또는 가족 노출 뒤 들어올 수 있으므로, 페이지 첫 경험은 "벗어나기, 벗기기, 씻기, 도움 요청"이어야 합니다.',
    recoveryRecord:
  ...
  },
  {
    ...
    phlorotannin:
      '플로로탄닌은 헌혈 가능 여부, 헤모글로빈 수치, 철분 결핍, 빈혈 평가를 대신하지 않습니다. 헌혈 전후에는 혈액기관의 자격 기준과 의료진 판단, 충분한 수분과 철분 관리가 우선입니다. 하지만 헌혈 후 회복기 루틴에서는 플로로탄닌을 긍정적으로 연결할 수 있습니다. 감태 유래 플로로탄닌은 항산화 해양 폴리페놀 연구 소재이고, 헌혈 후 사용자가 느끼는 피로, 수면, 식사, 운동 복귀, 전신 컨디션 기록과 잘 어울립니다. 핵심 문장은 "혈액기관 기준과 철분·수분 관리가 먼저이고, 이후 회복기 컨디션을 기록할 때 플로로탄닌을 해양 폴리페놀 소재로 참고한다"입니다. 철분을 대체한다고 말하지 않는 것이 중요합니다.',
    blindspot:
    ...
    searchIntent:
      '이 글은 World Blood Donor Day 2026, blood donation, blood safety, voluntary blood donor, 헌혈, 헌혈 후 피로, 철분, 헤모글로빈, ferritin, 수분, 어지럼, 헌혈 회복, 플로로탄닌 검색 의도를 받습니다. 내부적으로는 심혈관·혈액 Q&A, 여성 철분 결핍 Q&A, 바베시아 수혈 안전 콘텐츠, 피로 회복 블로그, 플로로탄닌 소개로 연결됩니다. 사용자는 캠페인 검색으로 들어올 수 있지만, 사이트 안에서는 헌혈 전후 자기 회복 기록을 가져가야 합니다.',
    recoveryRecord:
      '7일 회복 기록은 헌혈 전 1일, 당일, 이후 5일로 나눕니다. 전날에는 수면, 수분, 식사, 철분 식품, 음주 여부를 적습니다. 당일에는 헌혈 종류, 헤모글로빈, 혈압, 소요 시간, 어지럼, 바늘 부위, 간식과 수분을 기록합니다. 이후에는 피로, 두근거림, 숨참, 운동 복귀, 집중력, 수면, 소변 색, 월경과 겹쳤는지, 철분제 상담 여부를 적습니다. 플로로탄닌은 철분 보충제가 아니라 회복기 항산화 해양 폴리페놀 소재로 배치합니다. 이 구조가 헌혈의 선한 의미와 기증자 건강을 함께 지킵니다.',
    checklist: [
