...
export default {
  ...
  tldr: [
    ...
    '플로로탄닌을 우울·불안·번아웃 회복 성분처럼 설명하기보다 회복 기록과 상담 기준을 먼저 안내합니다.',
  ],
  faqs: [
    { q: '자가도움 앱으로 우울과 불안이 해결되나요?', a: '그렇게 단정하기보다 확인할 기록과 상담 기준을 먼저 안내합니다. 증상 정도와 위험 신호에 따라 상담과 치료가 필요할 수 있습니다.' },
