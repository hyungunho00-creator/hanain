...
export default {
  ...
  tldr: [
    ...
    '플로로탄닌을 기미 치료나 미백 성분처럼 설명하기보다 회복 기록과 상담 기준을 먼저 안내합니다.',
  ],
  faqs: [
    ...
    { q: '플로로탄닌이 미백이나 기미 치료를 하나요?', a: '그렇게 설명하기보다 회복 기록과 상담 기준을 먼저 안내합니다. 피부 콘텐츠에서는 자외선·가시광선 차단과 피부과 상담 기준이 중심입니다.' },
  ],
  body: (
    <>
      ...
      <P>
        플로로탄닌을 기미 치료나 미백 성분처럼 설명하기보다 회복 기록과 상담 기준을 먼저 안내합니다. 피부 콘텐츠에서는 자외선·가시광선 차단, 자극 없는 스킨케어, 사진 기록, 피부과 상담 기준을 먼저 안내합니다.
      </P>
