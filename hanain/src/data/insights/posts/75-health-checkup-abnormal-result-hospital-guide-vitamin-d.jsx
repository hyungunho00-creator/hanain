...
export default {
  ...
  title: "건강검진 이상소견 받았을 때: 어느 병원·어느 진료과로 가야 하나",
  description: "검진 결과지를 들고 재검·추적검사 경로를 정하고 싶다. 검진센터·내과 방문 전 증상·검사·복용약·비타민 D 상담 포인트를 정리했습니다.",
  keywords: "건강검진 이상소견 받았을 때, 검진센터·내과, 비타민 D, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "검진센터·내과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "건강검진에서 이상소견이 나오면 어느 병원부터 가야 하나요?",
      a: "네. 비타민 D 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 검진센터·내과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        검진 결과지를 들고 재검·추적검사 경로를 정하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        혈압, 혈당, 간수치, 콜레스테롤, 비타민 D 부족 등 검진표 이상이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        검진표에 즉시 진료 또는 정밀검사 권고가 있으면 예약을 미루지 않는 것이 좋습니다.
      </Callout>
