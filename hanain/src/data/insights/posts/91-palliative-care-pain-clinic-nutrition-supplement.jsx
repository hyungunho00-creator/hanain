...
export default {
  slug: "palliative-care-pain-clinic-nutrition-supplement",
  title: "완화의료·통증클리닉 상담: 진통제와 건강식품을 함께 기록",
  description: "통증 약과 보충제 병용을 안전하게 상담하고 싶다. 완화의료·통증클리닉 방문 전 증상·검사·복용약·마그네슘 상담 포인트를 정리했습니다.",
  keywords: "완화의료·통증클리닉 상담, 완화의료·통증클리닉, 마그네슘, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "완화의료·통증클리닉 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "통증클리닉에 갈 때 건강식품도 적어 가야 하나요?",
      a: "네. 마그네슘 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 완화의료·통증클리닉 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        통증 약과 보충제 병용을 안전하게 상담하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        암성통증, 만성통증, 수면불편, 변비이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        갑작스러운 마비, 의식 변화, 조절되지 않는 통증은 즉시 병원 연락이 필요합니다.
      </Callout>
