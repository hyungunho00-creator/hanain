...
export default {
  slug: "hypertension-hospital-home-bp-magnesium-omega3",
  title: "혈압 높을 때 병원 가기 전: 집혈압 기록과 마그네슘·오메가3 상담법",
  description: "고혈압 의심자가 병원 전 기록과 보충제 상담 포인트를 알고 싶다. 내과·심장내과 방문 전 증상·검사·복용약·마그네슘 상담 포인트를 정리했습니다.",
  keywords: "혈압 높을 때 병원 가기 전, 내과·심장내과, 마그네슘, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "내과·심장내과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
      "마그네슘 같은 건강식품원료는 치료 목적 표현이 아니라 복용 중인 원료와 용량을 의료진에게 공유하는 정보입니다.",
      "광고성 병원 추천보다 어떤 질문을 가져갈지가 실제 진료 만족도를 더 크게 좌우합니다.",
      "맛있으리 식단 상담이나 플로로탄닌 문의는 검사·치료 계획을 대신하지 않고 기록 정리를 돕는 CTA로만 연결합니다."
],
  faqs: [
    {
      q: "혈압이 높게 나오면 집혈압 기록을 가져가야 하나요?",
      a: "네. 마그네슘 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 내과·심장내과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        고혈압 의심자가 병원 전 기록과 보충제 상담 포인트를 알고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        가정혈압 상승, 두통, 어지럼, 검진 혈압 이상이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Table
        ...
        rows={[
          ...
          ['복용 목록', '약물·건강식품원료 병용 위험을 줄입니다', '처방약, 진통제, 마그네슘, 감태 플로로탄닌'],
      ...
      <P>
        마그네슘은 병원에서 "먹어도 되나요"라고만 묻기보다 제품명, 1일 섭취량, 시작한 날짜, 같이 먹는 약을 적어 가는 편이
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        가슴통증, 호흡곤란, 신경학적 이상, 매우 높은 혈압이 동반되면 응급 평가가 필요합니다.
      </Callout>
