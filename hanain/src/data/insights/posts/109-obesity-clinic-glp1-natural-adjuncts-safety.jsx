...
export default {
  slug: "obesity-clinic-glp1-natural-adjuncts-safety",
  title: "비만클리닉 상담: GLP-1 약과 천연 원료를 혼동하지 않기",
  description: "체중관리 병원 상담에서 원료와 약물을 구분하고 싶다. 비만클리닉·내분비내과 방문 전 증상·검사·복용약·베르베린 상담 포인트를 정리했습니다.",
  keywords: "비만클리닉 상담, 비만클리닉·내분비내과, 베르베린, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "비만클리닉·내분비내과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "비만클리닉 가기 전 GLP-1 관련 건강식품을 먹어도 되나요?",
      a: "네. 베르베린 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 비만클리닉·내분비내과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        체중관리 병원 상담에서 원료와 약물을 구분하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        복부비만, 체중증가, 혈당·지질 이상이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        급격한 체중감소, 심한 구토, 복통은 원인 평가가 필요합니다.
      </Callout>
