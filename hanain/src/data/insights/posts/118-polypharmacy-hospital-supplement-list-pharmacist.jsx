...
export default {
  ...
  description: "복용약과 보충제를 한 장으로 정리하고 싶다. 주치의·약사상담 방문 전 증상·검사·복용약·감태 플로로탄닌 상담 포인트를 정리했습니다.",
  keywords: "약이 많을 때 병원 상담, 주치의·약사상담, 감태 플로로탄닌, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "주치의·약사상담 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "약을 여러 개 먹으면 건강식품 목록을 어떻게 정리하나요?",
      a: "네. 감태 플로로탄닌 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 주치의·약사상담 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        복용약과 보충제를 한 장으로 정리하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        다약제 복용, 여러 병원 진료, 건강식품 병용이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        어지럼, 낙상, 출혈, 심한 졸림이 새로 생기면 약물 관련 평가가 필요합니다.
      </Callout>
