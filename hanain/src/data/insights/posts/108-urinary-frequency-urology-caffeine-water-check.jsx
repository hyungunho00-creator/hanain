...
export default {
  ...
  description: "야간뇨의 원인과 기록표를 알고 싶다. 비뇨의학과·내과 방문 전 증상·검사·복용약·마그네슘 상담 포인트를 정리했습니다.",
  keywords: "야간뇨 병원 상담, 비뇨의학과·내과, 마그네슘, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "비뇨의학과·내과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "밤에 소변 때문에 깨면 물만 줄이면 되나요?",
      a: "네. 마그네슘 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 비뇨의학과·내과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        야간뇨의 원인과 기록표를 알고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        야간뇨, 수면분절, 갈증, 빈뇨이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        혈뇨, 통증, 발열, 소변 정체가 있으면 빠른 진료가 필요합니다.
      </Callout>
