...
export default {
  slug: "dermatology-collagen-astaxanthin-skin-check",
  title: "피부과 상담: 콜라겐·아스타잔틴보다 병변 사진과 기간",
  description: "피부 증상과 먹는 원료를 병원에 설명하고 싶다. 피부과 방문 전 증상·검사·복용약·콜라겐 상담 포인트를 정리했습니다.",
  keywords: "피부과 상담, 피부과, 콜라겐, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "피부과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
      "콜라겐 같은 건강식품원료는 치료 목적 표현이 아니라 복용 중인 원료와 용량을 의료진에게 공유하는 정보입니다.",
      "광고성 병원 추천보다 어떤 질문을 가져갈지가 실제 진료 만족도를 더 크게 좌우합니다.",
      "맛있으리 식단 상담이나 플로로탄닌 문의는 검사·치료 계획을 대신하지 않고 기록 정리를 돕는 CTA로만 연결합니다."
],
  faqs: [
    {
      q: "피부 트러블로 피부과 갈 때 먹는 콜라겐도 말해야 하나요?",
      a: "네. 콜라겐 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 피부과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        피부 증상과 먹는 원료를 병원에 설명하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        발진, 가려움, 여드름, 색소침착, 건조이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Table
        ...
        rows={[
          ...
          ['복용 목록', '약물·건강식품원료 병용 위험을 줄입니다', '처방약, 진통제, 콜라겐, 감태 플로로탄닌'],
      ...
      <P>
        콜라겐은 병원에서 "먹어도 되나요"라고만 묻기보다 제품명, 1일 섭취량, 시작한 날짜, 같이 먹는 약을 적어 가는 편이
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        빠르게 번지는 발진, 물집, 호흡곤란, 고열이 동반되면 즉시 평가가 필요합니다.
      </Callout>
