...
export default {
  ...
  description: "수술 전 보충제와 출혈·마취 관련 질문을 정리하고 싶다. 수술 전 평가·마취통증의학과 방문 전 증상·검사·복용약·커큐민 상담 포인트를 정리했습니다.",
  keywords: "수술 전 병원 상담, 수술 전 평가·마취통증의학과, 커큐민, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "수술 전 평가·마취통증의학과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "수술 전 건강기능식품은 언제 중단해야 하나요?",
      a: "네. 커큐민 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 수술 전 평가·마취통증의학과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        수술 전 보충제와 출혈·마취 관련 질문을 정리하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        수술 예정, 시술 예정, 항응고제·진통제 복용이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        수술 전 임의 중단도 위험할 수 있어 담당 의료진 지시에 맞춰야 합니다.
      </Callout>
