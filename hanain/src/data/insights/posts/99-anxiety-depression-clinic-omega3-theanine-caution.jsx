...
export default {
  slug: "anxiety-depression-clinic-omega3-theanine-caution",
  title: "불안·우울 병원 상담: 오메가3·테아닌은 보조 자료로",
  description: "정신건강 상담에서 보충제와 증상기록을 함께 정리하고 싶다. 정신건강의학과 방문 전 증상·검사·복용약·오메가3 상담 포인트를 정리했습니다.",
  keywords: "불안·우울 병원 상담, 정신건강의학과, 오메가3, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "정신건강의학과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "불안할 때 오메가3나 테아닌을 먹는다고 병원에 말해야 하나요?",
      a: "네. 오메가3 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 정신건강의학과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        정신건강 상담에서 보충제와 증상기록을 함께 정리하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        불안, 우울감, 공황, 수면저하이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        자해 생각, 현실검증 저하, 극심한 불면은 빠르게 도움을 받아야 합니다.
      </Callout>
