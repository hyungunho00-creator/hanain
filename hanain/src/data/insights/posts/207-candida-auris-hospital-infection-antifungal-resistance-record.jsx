...
export default {
  ...
  tldr: [
    ...
    '플로로탄닌을 항진균 치료나 병원감염 예방 성분처럼 설명하기보다 회복 기록과 상담 기준을 먼저 안내합니다.',
  ],
  faqs: [
    ...
    { q: '건강식품으로 예방할 수 있나요?', a: '그렇게 단정하기보다 확인할 기록과 상담 기준을 먼저 세우는 편이 안전합니다. 의료기관 지침과 의료진 판단이 우선입니다.' },
  ],
  body: (
    <>
      ...
      <Callout type="warn" title="건강식품 문구로 연결하지 마세요">
        플로로탄닌을 C. auris 억제, 항진균 치료, 병원감염 예방 성분처럼 설명하기보다 회복 기록과 상담 기준을 먼저 안내합니다.
      </Callout>
      <H3>보호자에게 중요한 점</H3>
      <P>
