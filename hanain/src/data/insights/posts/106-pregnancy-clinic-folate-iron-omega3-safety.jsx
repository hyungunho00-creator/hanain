...
export default {
  slug: "pregnancy-clinic-folate-iron-omega3-safety",
  title: "임신 준비·임산부 병원 상담: 엽산·철·오메가3 안전하게 묻기",
  description: "임신 전후 영양성분과 금기 성분을 안전하게 확인하고 싶다. 산부인과 방문 전 증상·검사·복용약·오메가3 상담 포인트를 정리했습니다.",
  keywords: "임신 준비·임산부 병원 상담, 산부인과, 오메가3, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "산부인과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "임신 중 건강기능식품은 산부인과에 모두 말해야 하나요?",
      a: "네. 오메가3 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 산부인과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        임신 전후 영양성분과 금기 성분을 안전하게 확인하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        임신 준비, 임신 초기, 빈혈, 입덧, 영양제 선택이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        출혈, 심한 복통, 고혈압 증상, 태동 감소는 즉시 의료진 연락이 필요합니다.
      </Callout>
