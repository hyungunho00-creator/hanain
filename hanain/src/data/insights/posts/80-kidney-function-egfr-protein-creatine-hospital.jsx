...
export default {
  ...
  description: "신장기능 수치와 단백질·운동 보충제 상담 기준을 알고 싶다. 신장내과 방문 전 증상·검사·복용약·단백질·류신 상담 포인트를 정리했습니다.",
  keywords: "eGFR 낮을 때 신장내과 상담, 신장내과, 단백질·류신, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "신장내과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "신장수치가 낮으면 단백질 보충제를 중단해야 하나요?",
      a: "네. 단백질·류신 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 신장내과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        신장기능 수치와 단백질·운동 보충제 상담 기준을 알고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        eGFR 저하, 크레아티닌 상승, 단백뇨이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        붓기, 소변량 감소, 호흡곤란, 갑작스러운 체중증가가 있으면 빠른 평가가 필요합니다.
      </Callout>
