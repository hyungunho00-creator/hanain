...
export default {
  ...
  tldr: [
    ...
    '플로로탄닌은 항산화 연구 맥락에서 회복 루틴을 이해하는 참고 축이며 PFAS 노출을 해독하거나 제거한다고 단정하기보다 회복 기록과 상담 기준을 먼저 세우는 편이 안전합니다.',
  ],
  faqs: [
    {
      q: 'PFAS는 무엇인가요?',
    ...
    },
    {
      ...
      a: '그렇게 단정하기보다 확인할 기록과 상담 기준을 먼저 세우는 편이 안전합니다. 노출 저감과 수질 관리가 우선이고, 성분 정보는 대체 수단이 아닙니다.',
    },
  ],
  body: (
    <>
      ...
      <P>
        ...
        단정 표현보다 회복 기록과 상담 기준 안에서 참고합니다. 좋은 콘텐츠는 과장보다 확인할 자료와 생활 기록을 안내합니다.
      </P>
      <P>
