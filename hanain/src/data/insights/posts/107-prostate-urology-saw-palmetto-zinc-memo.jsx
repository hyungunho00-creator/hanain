...
export default {
  slug: "prostate-urology-saw-palmetto-zinc-memo",
  title: "전립선·비뇨의학과 상담: 쏘팔메토·아연보다 배뇨일지",
  description: "전립선 증상과 건강식품 관심을 병원 질문으로 바꾸고 싶다. 비뇨의학과 방문 전 증상·검사·복용약·감태 플로로탄닌 상담 포인트를 정리했습니다.",
  keywords: "전립선·비뇨의학과 상담, 비뇨의학과, 감태 플로로탄닌, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "비뇨의학과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "소변이 자주 마려우면 쏘팔메토를 먹기 전에 병원에 가야 하나요?",
      a: "네. 감태 플로로탄닌 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 비뇨의학과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        전립선 증상과 건강식품 관심을 병원 질문으로 바꾸고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        야간뇨, 빈뇨, 약한 소변줄기, 잔뇨감이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        소변이 전혀 안 나오거나 혈뇨, 발열, 심한 통증이 있으면 빠른 평가가 필요합니다.
      </Callout>
