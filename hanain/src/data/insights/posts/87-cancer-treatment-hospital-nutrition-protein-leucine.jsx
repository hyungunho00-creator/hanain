...
export default {
  ...
  description: "암 치료 중 식사와 보충제, 맛있으리 상담을 의료진과 연결하고 싶다. 종양내과·영양상담 방문 전 증상·검사·복용약·단백질·류신 상담 포인트를 정리했습니다.",
  keywords: "암 치료 병원 상담, 종양내과·영양상담, 단백질·류신, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "종양내과·영양상담 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "암 치료 중 단백질 보충이나 환자식단을 병원에 어떻게 말해야 하나요?",
      a: "네. 단백질·류신 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 종양내과·영양상담 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        암 치료 중 식사와 보충제, 맛있으리 상담을 의료진과 연결하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        식욕저하, 체중감소, 근감소 우려, 항암 중 식사 어려움이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
