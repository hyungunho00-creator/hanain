...
export default {
  ...
  tldr: [
      "방사선종양학과·영양상담 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  body: (
    <>
      ...
      <P speakable>
        방사선 치료 중 식사와 구강 불편을 기록하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        입마름, 삼킴불편, 피부 자극, 식사량 감소이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
