...
export default {
  ...
  description: "빈혈 원인과 영양성분 선택을 검사 기준으로 나누고 싶다. 내과·혈액내과·산부인과 방문 전 증상·검사·복용약·락토페린 상담 포인트를 정리했습니다.",
  keywords: "빈혈 병원 상담, 내과·혈액내과·산부인과, 락토페린, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "내과·혈액내과·산부인과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "빈혈이면 철분이나 락토페린을 바로 먹어도 되나요?",
      a: "네. 락토페린 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 내과·혈액내과·산부인과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        빈혈 원인과 영양성분 선택을 검사 기준으로 나누고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        어지럼, 피로, 창백함, 숨참, 페리틴 저하이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        흑변, 혈변, 심한 생리과다, 호흡곤란이 있으면 원인 평가가 우선입니다.
      </Callout>
