...
export default {
  slug: "colonoscopy-hospital-fiber-psyllium-prep-checklist",
  title: "대장내시경 전 병원 안내: 식이섬유·차전자피는 언제 조절하나",
  description: "대장내시경 준비와 먹는 원료 조절을 알고 싶다. 소화기내과·검진센터 방문 전 증상·검사·복용약·식이섬유 상담 포인트를 정리했습니다.",
  keywords: "대장내시경 전 병원 안내, 소화기내과·검진센터, 식이섬유, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "소화기내과·검진센터 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "대장내시경 전 식이섬유 보충제는 어떻게 해야 하나요?",
      a: "네. 식이섬유 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 소화기내과·검진센터 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        대장내시경 준비와 먹는 원료 조절을 알고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        대장내시경 예약, 변비, 대장암 검진 준비이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        혈변이나 원인 모를 체중감소가 있으면 검진이 아니라 진료로 접근해야 합니다.
      </Callout>
