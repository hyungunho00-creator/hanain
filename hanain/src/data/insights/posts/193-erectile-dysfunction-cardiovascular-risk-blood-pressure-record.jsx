...
export default {
  ...
  tldr: [
    ...
    '플로로탄닌을 발기부전 치료나 혈관 확장 성분처럼 설명하면 안 됩니다.',
  ],
  faqs: [
    ...
    { q: '플로로탄닌이 발기부전을 개선하나요?', a: '그렇게 설명하면 안 됩니다. 이 주제의 핵심은 혈관 위험 평가와 생활습관 기록입니다.' },
  ],
  body: (
    <>
      ...
      <P>
        플로로탄닌을 발기부전 치료나 혈관 확장 성분처럼 설명하면 안 됩니다. 남성건강 콘텐츠에서는 혈압·혈당·지질·수면·운동·복용약 점검을 중심에 둡니다.
      </P>
