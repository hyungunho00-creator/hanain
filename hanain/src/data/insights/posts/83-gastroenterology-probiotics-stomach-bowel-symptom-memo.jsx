...
export default {
  ...
  description: "복통·설사·변비를 병원에서 설명하기 쉽게 정리하고 싶다. 소화기내과 방문 전 증상·검사·복용약·프로바이오틱스 상담 포인트를 정리했습니다.",
  keywords: "소화기내과 가기 전, 소화기내과, 프로바이오틱스, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  faqs: [
    {
      q: "장 증상이 있을 때 프로바이오틱스 복용을 병원에 말해야 하나요?",
      a: "네. 프로바이오틱스 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 소화기내과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        복통·설사·변비를 병원에서 설명하기 쉽게 정리하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        복통, 설사, 변비, 더부룩함, 특정 음식 후 악화이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        혈변, 체중감소, 야간 설사, 발열, 빈혈이 있으면 정밀 평가가 필요합니다.
      </Callout>
