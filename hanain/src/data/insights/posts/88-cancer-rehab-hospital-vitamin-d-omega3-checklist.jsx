...
export default {
  slug: "cancer-rehab-hospital-vitamin-d-omega3-checklist",
  title: "암재활병원 찾기 전: 운동·영양·비타민D·오메가3 질문",
  description: "암재활병원 검색자가 프로그램과 영양상담을 비교하고 싶다. 암재활·재활의학과 방문 전 증상·검사·복용약·비타민 D 상담 포인트를 정리했습니다.",
  keywords: "암재활병원 찾기 전, 암재활·재활의학과, 비타민 D, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "암재활·재활의학과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "암재활병원 상담에서 어떤 질문을 먼저 해야 하나요?",
      a: "네. 비타민 D 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 암재활·재활의학과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        암재활병원 검색자가 프로그램과 영양상담을 비교하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        피로, 근력저하, 통증, 식사량 저하이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        새로운 통증, 호흡곤란, 신경학적 이상은 재활 전 담당 진료과 확인이 우선입니다.
      </Callout>
