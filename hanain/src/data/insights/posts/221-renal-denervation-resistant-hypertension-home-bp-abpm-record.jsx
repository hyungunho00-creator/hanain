...
export default {
  ...
  tldr: [
    ...
    '플로로탄닌을 혈압약 대체나 혈압 정상화 성분처럼 단정하기보다 회복 기록과 상담 기준을 먼저 세우는 편이 안전합니다.',
  ],
  faqs: [
    { q: '신장신경차단술을 하면 약을 끊을 수 있나요?', a: '그렇게 단정하기보다 확인할 기록과 상담 기준을 먼저 안내합니다. FDA 승인 자료도 생활습관과 항고혈압제의 보조 치료 맥락으로 설명합니다.' },
  ...
  body: (
    <>
      ...
      <Callout type="warn" title="혈압은 성분 연구와 생활 기록을 함께 보며 해결하는 영역이 아닙니다">
