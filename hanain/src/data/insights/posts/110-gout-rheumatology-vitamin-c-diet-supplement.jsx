...
export default {
  slug: "gout-rheumatology-vitamin-c-diet-supplement",
  title: "통풍 병원 상담: 요산수치·식단·비타민C를 한 번에 정리",
  description: "통풍 발작과 식단·보충제 질문을 정리하고 싶다. 류마티스내과·내과 방문 전 증상·검사·복용약·비타민 D 상담 포인트를 정리했습니다.",
  keywords: "통풍 병원 상담, 류마티스내과·내과, 비타민 D, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "류마티스내과·내과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "통풍이 있으면 비타민C나 식단을 어떻게 상담하나요?",
      a: "네. 비타민 D 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 류마티스내과·내과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        통풍 발작과 식단·보충제 질문을 정리하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        엄지발가락 통증, 관절 붓기, 요산 상승이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        발열을 동반한 관절부종은 감염성 관절염과 구분이 필요합니다.
      </Callout>
