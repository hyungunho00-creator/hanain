...
export default {
  slug: "autoimmune-rheumatology-omega3-vitamin-d-memo",
  title: "자가면역질환 류마티스내과 상담: 오메가3·비타민D 기록",
  description: "면역 관련 질환에서 보충제와 약물 상담을 안전하게 하고 싶다. 류마티스내과 방문 전 증상·검사·복용약·오메가3 상담 포인트를 정리했습니다.",
  keywords: "자가면역질환 류마티스내과 상담, 류마티스내과, 오메가3, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "류마티스내과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "자가면역질환이 있으면 건강식품을 모두 말해야 하나요?",
      a: "네. 오메가3 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 류마티스내과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        면역 관련 질환에서 보충제와 약물 상담을 안전하게 하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        관절통, 피로, 발진, 구강궤양, 면역억제제 복용이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        고열, 호흡곤란, 심한 감염 의심 증상은 즉시 의료진과 상의해야 합니다.
      </Callout>
