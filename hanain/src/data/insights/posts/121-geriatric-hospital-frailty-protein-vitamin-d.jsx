...
export default {
  ...
  description: "노인 허약과 식사·보충제를 병원 상담으로 연결하고 싶다. 노년내과·가정의학과 방문 전 증상·검사·복용약·단백질·류신 상담 포인트를 정리했습니다.",
  keywords: "노년내과·가정의학과 상담, 노년내과·가정의학과, 단백질·류신, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "노년내과·가정의학과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "부모님이 기력이 없으면 어느 병원에서 영양상담을 받을 수 있나요?",
      a: "네. 단백질·류신 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 노년내과·가정의학과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        노인 허약과 식사·보충제를 병원 상담으로 연결하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        기력저하, 식사량 감소, 낙상, 체중감소이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        갑작스러운 혼돈, 탈수, 발열, 호흡곤란은 빠른 진료가 필요합니다.
      </Callout>
