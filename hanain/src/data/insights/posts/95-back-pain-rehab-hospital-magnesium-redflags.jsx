...
export default {
  slug: "back-pain-rehab-hospital-magnesium-redflags",
  title: "허리통증 재활의학과 상담: 마그네슘보다 위험 신호 구분",
  description: "허리통증의 진료과와 생활관리 질문을 정리하고 싶다. 재활의학과·정형외과 방문 전 증상·검사·복용약·마그네슘 상담 포인트를 정리했습니다.",
  keywords: "허리통증 재활의학과 상담, 재활의학과·정형외과, 마그네슘, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "재활의학과·정형외과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "허리통증이 있을 때 재활의학과와 정형외과 중 어디로 가나요?",
      a: "네. 마그네슘 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 재활의학과·정형외과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        허리통증의 진료과와 생활관리 질문을 정리하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        요통, 다리 저림, 오래 앉으면 악화이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        대소변 장애, 회음부 감각저하, 진행성 근력저하는 즉시 평가가 필요합니다.
      </Callout>
