...
export default {
  slug: "dyslipidemia-clinic-omega3-coq10-statin-memo",
  title: "콜레스테롤 병원 상담: 오메가3·코큐텐보다 LDL 목표부터",
  description: "LDL·중성지방 수치와 보충제 복용을 병원에서 어떻게 말할지 궁금하다. 내과·심장내과 방문 전 증상·검사·복용약·오메가3 상담 포인트를 정리했습니다.",
  keywords: "콜레스테롤 병원 상담, 내과·심장내과, 오메가3, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      ...
      "오메가3 같은 건강식품원료는 치료 목적 표현이 아니라 복용 중인 원료와 용량을 의료진에게 공유하는 정보입니다.",
      "광고성 병원 추천보다 어떤 질문을 가져갈지가 실제 진료 만족도를 더 크게 좌우합니다.",
      "맛있으리 식단 상담이나 플로로탄닌 문의는 검사·치료 계획을 대신하지 않고 기록 정리를 돕는 CTA로만 연결합니다."
],
  faqs: [
    {
      q: "콜레스테롤이 높으면 오메가3와 코큐텐을 같이 물어봐도 되나요?",
      a: "네. 오메가3 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 내과·심장내과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        LDL·중성지방 수치와 보충제 복용을 병원에서 어떻게 말할지 궁금하다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        LDL 상승, 중성지방 상승, 스타틴 복용 또는 시작 고민이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Table
        ...
        rows={[
          ...
          ['복용 목록', '약물·건강식품원료 병용 위험을 줄입니다', '처방약, 진통제, 오메가3, 감태 플로로탄닌'],
      ...
      <P>
        오메가3은 병원에서 "먹어도 되나요"라고만 묻기보다 제품명, 1일 섭취량, 시작한 날짜, 같이 먹는 약을 적어 가는 편이
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        흉통이나 운동 시 숨참이 새로 생기면 단순 보충제 상담으로 넘기지 않아야 합니다.
      </Callout>
