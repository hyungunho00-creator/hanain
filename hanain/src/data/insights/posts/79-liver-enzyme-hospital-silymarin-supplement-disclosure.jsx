...
export default {
  slug: "liver-enzyme-hospital-silymarin-supplement-disclosure",
  title: "간수치 높을 때 병원 상담: 밀크씨슬보다 원인 분리가 먼저",
  description: "간수치 이상에서 건강식품과 음주·약물 기록을 정리하고 싶다. 소화기내과·간클리닉 방문 전 증상·검사·복용약·감태 플로로탄닌 상담 포인트를 정리했습니다.",
  keywords: "간수치 높을 때 병원 상담, 소화기내과·간클리닉, 감태 플로로탄닌, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "소화기내과·간클리닉 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
      "감태 플로로탄닌 같은 건강식품원료는 치료 목적 표현이 아니라 복용 중인 원료와 용량을 의료진에게 공유하는 정보입니다.",
      "광고성 병원 추천보다 어떤 질문을 가져갈지가 실제 진료 만족도를 더 크게 좌우합니다.",
      "맛있으리 식단 상담이나 플로로탄닌 문의는 검사·치료 계획을 대신하지 않고 기록 정리를 돕는 CTA로만 연결합니다."
],
  faqs: [
    {
      q: "간수치가 높으면 먹는 건강식품을 전부 말해야 하나요?",
      a: "네. 감태 플로로탄닌 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 소화기내과·간클리닉 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        간수치 이상에서 건강식품과 음주·약물 기록을 정리하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        AST·ALT·감마GTP 상승, 지방간 의심, 피로이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        황달, 짙은 소변, 심한 우상복부 통증, 발열이 있으면 빠른 진료가 필요합니다.
      </Callout>
