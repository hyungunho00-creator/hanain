...
export default {
  slug: "dizziness-ent-neurology-magnesium-check",
  title: "어지럼 병원 선택: 이비인후과·신경과와 마그네슘 기록",
  description: "어지럼 양상과 위험 신호를 구분하고 싶다. 이비인후과·신경과 방문 전 증상·검사·복용약·마그네슘 상담 포인트를 정리했습니다.",
  keywords: "어지럼 병원 선택, 이비인후과·신경과, 마그네슘, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "이비인후과·신경과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "어지럼은 이비인후과와 신경과 중 어디로 가야 하나요?",
      a: "네. 마그네슘 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 이비인후과·신경과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        어지럼 양상과 위험 신호를 구분하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        빙빙 도는 어지럼, 균형장애, 귀먹먹함, 두통이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        말 어눌함, 한쪽 마비, 심한 두통, 복시가 동반되면 응급 평가가 필요합니다.
      </Callout>
