...
export default {
  slug: "stroke-rehab-hospital-omega3-protein-caregiver",
  title: "뇌졸중 후 재활병원: 오메가3·단백질보다 기능 목표부터",
  description: "재활 목표와 영양 루틴을 보호자가 함께 정리하고 싶다. 재활의학과·신경과 방문 전 증상·검사·복용약·오메가3 상담 포인트를 정리했습니다.",
  keywords: "뇌졸중 후 재활병원, 재활의학과·신경과, 오메가3, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "재활의학과·신경과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "뇌졸중 후 재활병원 상담에서 식사와 보충제를 어떻게 묻나요?",
      a: "네. 오메가3 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 재활의학과·신경과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        재활 목표와 영양 루틴을 보호자가 함께 정리하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        마비 후 재활, 삼킴 문제, 체중감소, 피로이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        새로운 마비, 말 어눌함, 시야장애는 즉시 응급 평가가 필요합니다.
      </Callout>
