...
export default {
  slug: "anticoagulant-clinic-omega3-curcumin-supplement",
  title: "항응고제 복용자 병원 상담: 오메가3·커큐민·은행잎 주의",
  description: "출혈 위험과 건강식품 병용을 상담하고 싶다. 심장내과·항응고클리닉 방문 전 증상·검사·복용약·오메가3 상담 포인트를 정리했습니다.",
  keywords: "항응고제 복용자 병원 상담, 심장내과·항응고클리닉, 오메가3, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "심장내과·항응고클리닉 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "항응고제를 먹으면 오메가3나 커큐민도 병원에 말해야 하나요?",
      a: "네. 오메가3 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 심장내과·항응고클리닉 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        출혈 위험과 건강식품 병용을 상담하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        와파린·DOAC 복용, 멍, 코피, 시술 예정이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        검은변, 토혈, 멈추지 않는 출혈은 즉시 진료가 필요합니다.
      </Callout>
