...
export default {
  slug: "gallbladder-pancreas-pain-hospital-supplement-check",
  title: "우상복부 통증 병원 선택: 담낭·췌장 의심 때 건강식품 기록",
  description: "복통 위치와 응급 신호를 구분하고 싶다. 소화기내과·응급의학과 방문 전 증상·검사·복용약·오메가3 상담 포인트를 정리했습니다.",
  keywords: "우상복부 통증 병원 선택, 소화기내과·응급의학과, 오메가3, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "소화기내과·응급의학과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "오른쪽 윗배가 아프면 어느 병원으로 가야 하나요?",
      a: "네. 오메가3 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 소화기내과·응급의학과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        복통 위치와 응급 신호를 구분하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        오른쪽 윗배 통증, 기름진 음식 후 통증, 구역감이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        발열, 황달, 지속되는 심한 통증, 반복 구토가 있으면 응급 평가가 필요합니다.
      </Callout>
