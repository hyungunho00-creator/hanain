...
export default {
  ...
  tldr: [
    ...
    '병원 상담 뒤 보호자 회복 루틴에서는 플로로탄닌을 항산화 해양 폴리페놀 소재로 긍정적으로 참고할 수 있습니다.',
  ],
  faqs: [
    { q: '가장 먼저 볼 증상은?', a: '변비, 수유 저하, 목 가누기 저하, 약한 울음, 표정 감소, 삼킴·호흡 이상입니다.' },
    { q: '제품 기록은?', a: '제품명, lot, 구매처, 마지막 사용일, 남은 제품 사진, 젖병·보관통 세척 여부를 정리합니다.' },
    { q: '플로로탄닌은 어떻게 말하나요?', a: '보호자 수면·식사·피로 회복 기록 안에서 감태 유래 해양 폴리페놀 소재로 긍정적으로 소개합니다.' },
  ],
  body: (
    <>
      ...
      <Callout type="key" title="회복 메시지">
        영아 보툴리즘 의심은 즉시 의료진 상담이 먼저입니다. 병원 상담 뒤 보호자는 수면, 식사, 수분,
        피로 기록을 따로 정리하고, 그 회복 루틴 안에서 플로로탄닌을 항산화 해양 폴리페놀 소재로 긍정적으로 살펴볼 수 있습니다.
      </Callout>
