...
export default {
  ...
  title: "보호자 병원 메모: 검사결과·식사기록·맛있으리 상담 연결",
  description: "보호자가 환자 식사와 상담 내용을 빠짐없이 정리하고 싶다. 주치의·영양상담 방문 전 증상·검사·복용약·단백질·류신 상담 포인트를 정리했습니다.",
  keywords: "보호자 병원 메모, 주치의·영양상담, 단백질·류신, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "주치의·영양상담 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "보호자가 병원 갈 때 식사기록을 어떻게 가져가면 좋나요?",
      a: "네. 단백질·류신 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 주치의·영양상담 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        보호자가 환자 식사와 상담 내용을 빠짐없이 정리하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        식사량 감소, 체중변화, 환자식단 고민, 상담 준비이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        환자가 거의 먹지 못하거나 탈수·발열이 있으면 식단 문의보다 진료 연락이 먼저입니다.
      </Callout>
