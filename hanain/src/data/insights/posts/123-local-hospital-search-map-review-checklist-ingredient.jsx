...
export default {
  ...
  title: "동별 병원 검색을 정보 자산으로 바꾸기: 리뷰보다 질문 리스트",
  description: "지역 병원 검색에서 광고성 정보와 실전 질문을 구분하고 싶다. 동네의원·전문클리닉 방문 전 증상·검사·복용약·감태 플로로탄닌 상담 포인트를 정리했습니다.",
  keywords: "동별 병원 검색을 정보 자산으로 바꾸기, 동네의원·전문클리닉, 감태 플로로탄닌, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "동네의원·전문클리닉 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "동네 병원 검색할 때 리뷰보다 먼저 볼 기준은 무엇인가요?",
      a: "네. 감태 플로로탄닌 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 동네의원·전문클리닉 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        지역 병원 검색에서 광고성 정보와 실전 질문을 구분하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        어디동 내과, 어디동 피부과, 어디동 재활의학과 검색이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        응급 신호가 있으면 가까운 병원 리뷰 비교보다 응급 대응이 우선입니다.
      </Callout>
