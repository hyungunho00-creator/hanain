...
export default {
  slug: "dental-oral-dry-mouth-nutrition-hospital",
  title: "구강건조·구내염 병원 상담: 치과·이비인후과·영양 기록",
  description: "구강 증상과 영양상태를 함께 점검하고 싶다. 치과·이비인후과 방문 전 증상·검사·복용약·락토페린 상담 포인트를 정리했습니다.",
  keywords: "구강건조·구내염 병원 상담, 치과·이비인후과, 락토페린, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "치과·이비인후과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
      "락토페린 같은 건강식품원료는 치료 목적 표현이 아니라 복용 중인 원료와 용량을 의료진에게 공유하는 정보입니다.",
      "광고성 병원 추천보다 어떤 질문을 가져갈지가 실제 진료 만족도를 더 크게 좌우합니다.",
      "맛있으리 식단 상담이나 플로로탄닌 문의는 검사·치료 계획을 대신하지 않고 기록 정리를 돕는 CTA로만 연결합니다."
],
  faqs: [
    {
      q: "입이 마르고 헐면 치과와 이비인후과 중 어디로 가나요?",
      a: "네. 락토페린 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 치과·이비인후과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        구강 증상과 영양상태를 함께 점검하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        구강건조, 구내염, 입맛 변화, 삼킴불편이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Table
        ...
        rows={[
          ...
          ['복용 목록', '약물·건강식품원료 병용 위험을 줄입니다', '처방약, 진통제, 락토페린, 감태 플로로탄닌'],
      ...
      <P>
        락토페린은 병원에서 "먹어도 되나요"라고만 묻기보다 제품명, 1일 섭취량, 시작한 날짜, 같이 먹는 약을 적어 가는 편이
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        삼키기 어렵거나 고열, 면역저하 상태의 구강감염은 빠른 진료가 필요합니다.
      </Callout>
