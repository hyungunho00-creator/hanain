...
export default {
  slug: "hair-loss-clinic-iron-vitamin-d-zinc-check",
  title: "탈모 병원 상담: 철·비타민D·아연 검사와 복용기록",
  description: "탈모 원인검사와 건강식품을 구분하고 싶다. 피부과·탈모클리닉 방문 전 증상·검사·복용약·비타민 D 상담 포인트를 정리했습니다.",
  keywords: "탈모 병원 상담, 피부과·탈모클리닉, 비타민 D, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "피부과·탈모클리닉 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "탈모가 있으면 비타민D나 철분 검사를 같이 물어봐도 되나요?",
      a: "네. 비타민 D 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 피부과·탈모클리닉 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        탈모 원인검사와 건강식품을 구분하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        모발 가늘어짐, 원형탈모, 산후탈모, 두피 가려움이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        갑작스러운 원형 탈모나 염증성 두피 병변은 조기 진료가 좋습니다.
      </Callout>
