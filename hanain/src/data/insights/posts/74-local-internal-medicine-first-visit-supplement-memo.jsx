...
export default {
  ...
  title: "동네 내과 첫 방문 전: 증상·복용약·건강식품원료 메모법",
  description: "동네 내과를 찾는 사람이 진료 전 무엇을 준비해야 하는지 알고 싶다. 내과·가정의학과 방문 전 증상·검사·복용약·감태 플로로탄닌 상담 포인트를 정리했습니다.",
  keywords: "동네 내과 첫 방문 전, 내과·가정의학과, 감태 플로로탄닌, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "내과·가정의학과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "동네 내과 갈 때 건강기능식품도 적어 가야 하나요?",
      a: "네. 감태 플로로탄닌 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 내과·가정의학과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        동네 내과를 찾는 사람이 진료 전 무엇을 준비해야 하는지 알고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        피로, 혈압·혈당 걱정, 소화 불편처럼 원인이 넓은 증상이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        흉통, 호흡곤란, 한쪽 마비, 의식저하가 있으면 진료 예약보다 응급 평가가 먼저입니다.
      </Callout>
