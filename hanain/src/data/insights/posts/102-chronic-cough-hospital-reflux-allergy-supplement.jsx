...
export default {
  slug: "chronic-cough-hospital-reflux-allergy-supplement",
  title: "만성기침 병원 선택: 호흡기·이비인후과·역류를 나누는 법",
  description: "만성기침 원인과 진료과 선택을 정리하고 싶다. 호흡기내과·이비인후과 방문 전 증상·검사·복용약·프로바이오틱스 상담 포인트를 정리했습니다.",
  keywords: "만성기침 병원 선택, 호흡기내과·이비인후과, 프로바이오틱스, 병원 질문 리스트, 건강식품 상담",
  publishedAt: PUB,
  updatedAt: PUB,
  ...
  tldr: [
      "호흡기내과·이비인후과 상담은 병원 이름보다 증상 기간, 검사수치, 복용약, 식사·수면 기록이 먼저입니다.",
  ...
  faqs: [
    {
      q: "기침이 오래가면 어느 병원부터 가야 하나요?",
      a: "네. 프로바이오틱스 포함 건강식품원료, 처방약, 일반의약품, 최근 검사 결과를 함께 적어 가면 호흡기내과·이비인후과 상담에서 중복 복용과 주의 상황을 더 빨리 확인할 수 있습니다.",
    },
    {
  ...
  body: (
    <>
      ...
      <P speakable>
        만성기침 원인과 진료과 선택을 정리하고 싶다. 이때 가장 흔한 실수는 병원명, 거리, 리뷰만 보고 바로 예약하는 것입니다. 실제 상담에서는
        8주 이상 기침, 목 이물감, 가래, 역류 증상이 언제 시작됐는지, 무엇을 하면 악화되는지, 최근 검사 수치가 어떤지, 처방약과 건강식품원료를
        함께 쓰고 있는지가 더 중요합니다.
      </P>
      ...
      <Callout type="warn" title="응급·빠른 진료 기준">
        객혈, 체중감소, 고열, 숨참이 있으면 빠르게 진료가 필요합니다.
      </Callout>
