...
import { ROUND71_TREND_BLOG_POSTS } from './localTrendBlogPostsRound71.js'
import { ROUND72_TREND_BLOG_POSTS } from './localTrendBlogPostsRound72.js'
import { ROUND73_TREND_BLOG_POSTS } from './localTrendBlogPostsRound73.js'
...
const TREND_POST_CONFIGS = [
  ...
  },
  {
    ...
    title: '혈당 스파이크 줄이는 식사순서: 저속노화 독자가 먼저 볼 기준',
    ...
    tldr: [
      ...
      '식후 10분 걷기와 수면 기록은 혈당 스파이크 독자에게 가장 이해하기 쉬운 확장 키워드입니다.',
  ...
  },
  {
    ...
    title: '플로로탄닌과 비타민D: 면역·염증 독자가 같이 확인할 것',
...
※ 본 글은 건강정보 제공 목적이며 진단·치료 결정을 대체하지 않습니다. 처방약 복용 중이거나 질환 치료 중이라면 의료진과 먼저 상담하세요.`,
  ...
  },
  {
    ...
    excerpt: '초가공식품, 혈당 스파이크, 만성염증, 장내미생물 키워드를 플로로탄닌·해양 폴리페놀 정보와 연결한 정보구조 확장 글입니다.',
    category: 'metabolism',
...
export const LOCAL_TREND_BLOG_POSTS = [
  ...
  ...ROUND71_TREND_BLOG_POSTS,
  ...ROUND72_TREND_BLOG_POSTS,
  ...ROUND73_TREND_BLOG_POSTS,
