...
const CATEGORY_POST_CONFIGS = [
  ...
  {
    slug: 'gamtae-taking-time-empty-stomach-after-meal-guide-2026',
    title: '감태추출물 복용시간 2026: 공복·식후·취침 전 언제 확인할까',
    excerpt: '감태추출물 복용시간을 공복/식후/취침 전으로 나눠 기록하고 해석하는 안전한 루틴을 정리했습니다.',
    category: 'buying-guide',
    tags: ['감태추출물', '복용시간', '공복', '식후', '섭취시간'],
    problem: '복용시간 검색은 많지만 개인 루틴·복용약·수면패턴을 빼고 단일 정답만 찾다 보니 오히려 해석이 꼬이는 경우가 많습니다.',
    context: '실전에서는 “언제 먹어야 가장 좋다”보다 “내 생활에서 어떤 시간대가 가장 안정적인지”를 기록 기반으로 찾는 방식이 정확합니다.',
    tldr: [
      '공복/식후/취침 전은 체감과 위장 반응이 다를 수 있어 2주 비교가 필요합니다.',
      '수면제·항불안제·갑상선약·항응고제 복용 중이면 시간 간격을 먼저 확인해야 합니다.',
      '변경은 한 번에 하나만 해야 원인 추적이 가능합니다.',
    ],
    checklist: [
      '복용 시간대(공복/식후/취침 전) 고정',
      '위장 불편, 졸림, 집중도, 수면질 1~5점 기록',
      '복용약/보충제와 간격 기록',
      '카페인·음주·야식 시간 기록',
      '2주 후 한 항목만 조정',
    ],
    questions: [
      '제 복용약 기준으로 피해야 할 시간대가 있나요?',
      '취침 전 복용 시 주의할 점은 무엇인가요?',
      '체감이 불안정하면 어떤 순서로 조정하는 게 좋나요?',
    ],
    blindspot: '복용시간을 자주 바꾸면 어떤 조건에서 좋아졌는지 파악이 안 됩니다. 최소 1~2주 동일 조건을 유지해야 비교가 됩니다.',
    actionPlan: ['기준선 2주', '변경 1개', '상담용 요약표 작성'],
    sources: [
  ...
  {
    slug: 'gamtae-price-comparison-per-day-intake-guide-2026',
    title: '감태 가격 비교 2026: 총액보다 1일 섭취량 기준으로 보는 법',
    excerpt: '감태 제품 가격을 총액이 아닌 1일 섭취량·표준화·검사자료 기준으로 비교하는 체크리스트입니다.',
    category: 'buying-guide',
    tags: ['감태 가격', '감태추출물', '1일 섭취량', '가성비', '표준화'],
    problem: '가격 비교를 제품 총액만으로 하면 원료 형태·함량·표준화 차이를 놓쳐 잘못된 결론으로 이어지기 쉽습니다.',
    context: '같은 감태라도 원물/분말/추출물/복합제형의 비교 단위가 달라, 1일 섭취량 환산과 표준화 지표 확인이 기본입니다.',
    tldr: [
      '총액이 아니라 1일 섭취량 비용으로 비교해야 정확합니다.',
      '표준화 지표(디에콜/플로로탄닌)와 검사성적서 유무를 함께 봐야 합니다.',
      '저가 제품일수록 함량·주의문구·제조정보 확인이 중요합니다.',
    ],
    checklist: [
      '1일 권장량 기준 총 복용일수 계산',
      '1일 비용(원/일) 환산',
      '지표성분 표기와 함량 확인',
      '검사성적서·제조원·로트·유통기한 확인',
      '복합 제형은 중복 성분 여부 확인',
    ],
    questions: [
      '같은 가격대에서 우선 볼 품질 지표는 무엇인가요?',
      '복합제형과 단일제형 중 현재 상황에 맞는 선택은 무엇인가요?',
      '지표성분이 없는 제품은 어떻게 판단해야 하나요?',
    ],
    blindspot: '“비싼 게 무조건 좋다”도, “싼 게 가성비”도 아닙니다. 비교 단위를 통일하지 않으면 판단이 흔들립니다.',
    actionPlan: ['1일 비용 환산표 작성', '품질 지표 체크', '상담 후 최종 선택'],
    sources: [
      ['NCCIH: Dietary Supplements', 'https://www.nccih.nih.gov/health/using-dietary-supplements-wisely'],
      ['EFSA scientific opinion (Ecklonia cava phlorotannins)', 'https://www.efsa.europa.eu/en/efsajournal/pub/5003'],
    ],
  },
  {
    slug: 'gamtae-side-effects-warning-signs-checklist-2026',
    title: '감태 부작용 체크리스트 2026: 중단 신호와 상담 기준',
    excerpt: '감태·감태추출물 복용 중 확인할 경고 신호와 중단/상담 기준을 기록 중심으로 정리했습니다.',
    category: 'safety-precautions',
    tags: ['감태 부작용', '주의사항', '상호작용', '안전성', '상담기준'],
    problem: '부작용 검색은 극단 사례 위주로 소비되기 쉬워 실제로는 어떤 신호를 기록하고 언제 상담해야 하는지 기준이 부족합니다.',
    context: '안전 관리는 “먹을까 말까”보다 복용 전 체크, 복용 중 모니터링, 이상 신호 대응 기준을 갖추는 것이 핵심입니다.',
    tldr: [
      '복용 전 병력·복용약·해조류 알레르기 여부 확인이 먼저입니다.',
      '불편 신호가 생기면 즉시 중단 후 기록을 들고 상담하는 편이 안전합니다.',
      '특히 갑상선 질환·항응고제 복용자는 임의 병용을 피해야 합니다.',
    ],
    checklist: [
      '복용 시작일·용량·시간 기록',
      '어지럼, 두근거림, 소화불편, 수면변화 기록',
      '복용약(항응고제·갑상선약 등) 동시 복용 여부 기록',
      '식사/카페인/음주 변화 기록',
      '중단 후 회복 양상 기록',
    ],
    questions: [
      '현재 증상이 원료 반응인지 다른 요인인지 어떻게 구분하나요?',
      '제 약물 조합에서 특히 주의할 상호작용은 무엇인가요?',
      '다시 시작할 수 있는지, 시작한다면 어떤 기준이 필요한가요?',
    ],
    blindspot: '증상이 생겨도 기록이 없으면 상담 정확도가 떨어집니다. 날짜·시간·용량 기록이 가장 중요한 안전장치입니다.',
    actionPlan: ['복용 전 체크', '이상 신호 즉시 중단', '상담 후 재개 여부 판단'],
    sources: [
      ['NCCIH: Safety and supplements', 'https://www.nccih.nih.gov/health/using-dietary-supplements-wisely'],
      ['Mayo Clinic: Dietary supplements safety', 'https://www.mayoclinic.org/healthy-lifestyle/consumer-health/in-depth/dietary-supplements/art-20044894'],
    ],
  },
  {
    slug: 'gamtae-review-reading-evidence-check-guide-2026',
    title: '감태 후기 읽는 법 2026: 광고성 후기와 정보성 후기 구분 기준',
    excerpt: '감태 후기·리뷰를 볼 때 과장 문구를 걸러내고 실제 판단에 도움이 되는 정보만 남기는 방법입니다.',
    category: 'research',
    tags: ['감태 후기', '리뷰 검증', '근거 확인', '광고 구분', '정보 리터러시'],
    problem: '후기 검색에서 체험담과 광고 문구가 혼재되어 실제로는 검증 가능한 정보가 무엇인지 구분하기 어렵습니다.',
    context: '후기는 참고자료일 뿐이며, 성분표·표준화·섭취조건·복용약 맥락이 함께 있을 때만 해석 가치가 생깁니다.',
    tldr: [
      '후기 자체보다 복용 조건(용량·기간·시간)이 적힌 후기의 신뢰도가 높습니다.',
      '질병 치료·예방 단정 문구는 우선 제외하고 봐야 합니다.',
      '최종 판단은 라벨 정보·안전성 자료·상담 가능성으로 결정해야 합니다.',
    ],
    checklist: [
      '복용 조건(용량·기간·시간) 기재 여부 확인',
      '동시 복용약/식습관 정보 기재 여부 확인',
      '과장 문구(치료·완치 단정) 여부 확인',
      '제품 라벨·표준화·검사자료 교차 확인',
      '후기와 내 상황의 차이점 정리',
    ],
    questions: [
      '이 후기에서 실제로 참고 가능한 정보는 무엇인가요?',
      '내 병력/복용약에서 제외해야 할 신호는 무엇인가요?',
      '후기 기반 판단을 보완하려면 어떤 자료를 추가 확인해야 하나요?',
    ],
    blindspot: '후기 수가 많다고 근거 수준이 높아지지는 않습니다. 출처와 조건이 없는 체험담은 재현이 어렵습니다.',
    actionPlan: ['후기 선별표 작성', '라벨 교차 검증', '상담 질문지 준비'],
    sources: [
      ['Google News Initiative: evaluating search information', 'https://newsinitiative.withgoogle.com/ko-kr/resources/trainings/data-journalism/google-trends-improving-search-results/'],
      ['NCCIH: Evaluating supplement claims', 'https://www.nccih.nih.gov/health/using-dietary-supplements-wisely'],
    ],
  },
]
