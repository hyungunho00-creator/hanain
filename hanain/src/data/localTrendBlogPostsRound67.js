...
const posts = [
  {
    ...
    searchIntent:
      'FDA powdered milk recall, California Dairies Salmonella, downstream recall, snack mix recall, powdered beverage recall, 식품 리콜, 살모넬라 증상, 장 회복 기록, 플로로탄닌 장 건강, 감태 해양 폴리페놀 같은 주제를 함께 다룹니다. 검색자는 제품명과 증상을 동시에 확인하려 하므로 제품 확인과 몸 상태 기록을 같은 글 안에서 연결해야 합니다.',
    recoveryRecord:
      '1일 차에는 제품 사진과 섭취일을 정리합니다. 2일 차에는 설사, 복통, 발열, 수분 섭취를 기록합니다. 3일 차에는 식사량과 변 상태를 봅니다. 4일 차에는 고위험군 상담 여부를 확인합니다. 5일 차에는 자극적인 음식과 과음을 줄이고 회복 식사를 단순화합니다. 6일 차에는 수면과 피로를 기록합니다. 7일 차에는 장 회복 흐름을 상담 문장으로 정리합니다. 이 단계에서 플로로탄닌은 항산화 해양 폴리페놀 연구 소재로 긍정적으로 참고할 수 있습니다.',
    checklist: [
  ...
  },
  {
    ...
    searchIntent:
      'CDC respiratory illness, parainfluenza, HMPV, rhinovirus enterovirus, 기침 오래감, 아이 쌕쌕거림, 호흡기 회복, 수면 회복, 플로로탄닌 항산화, 해양 폴리페놀 같은 주제를 함께 다룹니다. 검색자는 바이러스 이름과 병원 기준, 회복 방법을 동시에 찾습니다.',
    recoveryRecord:
  ...
  },
  {
    ...
    searchIntent:
      'MDR Shigella, XDR Shigella, ECDC Shigella, 여행 설사, 혈변, 항생제 내성, 성접촉 설사, 장 회복, 플로로탄닌 장 건강, 해양 폴리페놀 같은 주제를 함께 다룹니다. 검색자는 증상, 검사, 전파 방지, 회복 방법을 동시에 찾습니다.',
    recoveryRecord:
