...
const posts = [
  {
    ...
    searchIntent:
      '이 글의 정보구조 의도는 “홍역 증상”, “MMR 접종”, “해외여행 홍역”, “홍역 발진”, “면역 회복”, “플로로탄닌 회복 루틴”을 한 문맥 안에서 연결하는 것입니다. 내부 연결은 감염/염증 Q&A, 플로로탄닌 소개, 홍역 관련 인사이트로 이어지게 설계했습니다. 중요한 점은 플로로탄닌을 주제 밖으로 밀어내지 않는 것입니다. 급성 대응은 공식 지침으로 두고, 회복기에는 전신 시스템을 안정시키는 생활 리듬의 언어로 플로로탄닌을 배치합니다. 이렇게 하면 의료 과장은 피하면서도 브랜드 정체성은 선명하게 남습니다.',
    recoveryRecord:
