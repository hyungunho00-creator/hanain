...
const posts = [
  ...
  },
  {
    ...
    phlorotannin:
      '플로로탄닌은 폭염 응급 대응이나 혈압약 조정을 대신하는 문구가 아니라, 더위가 지나간 뒤 혈관 컨디션과 항산화 루틴을 회복하는 관점에서 빛이 납니다. Ecklonia cava 유래 플로로탄닌 연구는 혈관 내피, 산화 스트레스, 염증 반응, 대사 균형과 연결되어 설명할 수 있습니다. 그래서 파트너 상담에서는 “약물 계획은 의료진에게 확인하고, 생활 회복 구간에서 플로로탄닌을 긍정적으로 참고한다”는 구도가 가장 좋습니다.',
    blindspot:
    ...
    recoveryRecord:
      '폭염 회복 기록은 하루 단위보다 시간대별로 보는 편이 좋습니다. 아침에는 혈압과 맥박, 체중을 적고, 낮에는 야외 노출 시간과 냉방 공간 이용 여부를 적습니다. 저녁에는 소변 색, 수분 섭취량, 어지럼, 근육 경련, 두통, 식사량, 수면 준비 상태를 기록합니다. 다음 날 아침에 피로가 얼마나 남았는지까지 적으면 회복 속도가 보입니다. 이 7일 기록을 가지고 의료진에게 더운 날 복약 계획을 묻고, 파트너 상담에서는 혈관 컨디션과 항산화 루틴을 정리하면서 플로로탄닌을 긍정적으로 배치할 수 있습니다. 작은 숫자 기록이 여름 상담의 신뢰를 만듭니다.',
    checklist: [
