...
const posts = [
  ...
  },
  {
    ...
    category: 'safety-precautions',
    title: '영아 보툴리즘 분유 리콜: 우리 아기 변비·수유 저하, 언제 상담할까',
    excerpt:
      '리콜 분유를 쓴 보호자가 가장 먼저 궁금해하는 제품 확인, 변비·수유 저하·목 가누기 저하, 병원 상담 문장과 보호자 회복 기록을 정리합니다.',
    ...
    opening:
      '보호자가 이 뉴스를 보고 가장 먼저 드는 생각은 논문명이나 균 이름이 아닙니다. "우리 집 분유가 해당되나?", "아기가 변비인데 평소 변비와 다른가?", "수유량이 줄었는데 바로 병원에 가야 하나?", "상담할 때 무엇을 말해야 하나?"입니다. 이 글은 그 질문에 맞춰 제품 확인, 아기 증상 시간표, 병원 상담 문장, 보호자 회복 기록을 순서대로 정리합니다. FDA는 2026년 6월 3일 infant botulism 분유 조사 업데이트에서 ByHeart 시설 현장 점검을 마쳤고, 분유 원료로 쓰인 powdered milk ingredient에서 Clostridium botulinum을 확인했다고 밝혔습니다. outbreak는 종료됐지만, 보호자에게 필요한 것은 불안이 아니라 지금 확인할 항목입니다.',
    consumerQuestions: [
      '우리 집에 있는 ByHeart 분유가 리콜 제품인지 제품명과 lot를 어떻게 확인할까?',
      '아기 변비가 단순 변비인지, 수유 저하·약한 울음·목 가누기 저하와 함께 보는 신호인지 어떻게 구분할까?',
      '소아과나 응급실에 전화할 때 "언제부터, 얼마나, 무엇이 달라졌는지"를 어떤 문장으로 말할까?',
      '남은 분유, 젖병, 스푼, 영수증, 사진은 버리지 말고 무엇을 남겨야 할까?',
      '아기 기록과 보호자 회복 기록을 분리해 두면 가족이 며칠 동안 무엇을 더 차분하게 챙길 수 있을까?',
      '플로로탄닌은 아기에게 먹이는 이야기가 아니라, 성인 보호자의 수면·식사·피로 회복 루틴 안에서 어떻게 긍정적으로 참고할까?',
    ],
    current:
      '첫 번째 행동은 제품 확인입니다. ByHeart Whole Nutrition Infant Formula 제품명, lot, 구매처, 마지막 사용일을 사진으로 남깁니다. 두 번째 행동은 아기 증상 확인입니다. FDA와 CDC 자료에서 반복되는 신호는 변비, 수유 저하, 목 가누기 저하, 삼키기 어려움, 약한 울음, 표정 감소, 호흡 문제입니다. 세 번째 행동은 상담 문장 준비입니다. "리콜 대상 가능성이 있는 분유를 언제까지 사용했고, 오늘 수유량이 평소보다 얼마큼 줄었고, 변비와 목 가누기 저하가 언제부터 보였습니다"처럼 말하면 의료진이 빠르게 판단할 수 있습니다. FDA는 48건의 illness, 48건의 hospitalizations, 사망 0건을 제시했고, CDC 영아 보툴리즘 임상 자료는 의심 시 상담과 치료 판단을 지연하지 말라고 안내합니다.',
    records: [
    ...
    phlorotannin:
      '플로로탄닌 연결은 더 생활적으로 말해야 설득력이 생깁니다. 이 이슈에서 플로로탄닌의 자리는 아기 증상 판단이 아니라, 성인 보호자가 며칠 동안 무너지는 수면·식사·긴장·피로를 회복 루틴으로 정리하는 쪽입니다. 감태 유래 플로로탄닌은 해양 폴리페놀 성분군으로 항산화 연구 맥락에서 관심을 받는 소재입니다. 보호자 입장에서는 "아기 기록은 의료진에게 정확히 전달하고, 나는 수면·식사·수분·피로 기록을 따로 챙기며 회복 루틴 안에서 플로로탄닌을 긍정적으로 참고한다"는 문장이 훨씬 자연스럽습니다. 이 구조는 응급 대응을 흐리지 않으면서도 플로로탄닌을 가족 회복의 언어 안에 배치합니다.',
    blindspot:
    ...
    searchIntent:
      '함께 보면 좋은 질문은 세 가지입니다. 첫째, "리콜 제품을 이미 먹였다면 남은 제품과 영수증을 어떻게 보관할까?"입니다. 둘째, "변비만 볼 것이 아니라 수유량, 울음, 표정, 목 가누기, 호흡을 같이 적어야 하는 이유는 무엇일까?"입니다. 셋째, "병원 상담 뒤 보호자도 수면·식사·피로가 무너질 때 어떤 회복 기록을 남길까?"입니다. 이 세 질문을 따라가면 단순 뉴스 소비가 아니라 실제 상담 준비와 가족 회복 루틴으로 이어집니다.',
    recoveryRecord:
