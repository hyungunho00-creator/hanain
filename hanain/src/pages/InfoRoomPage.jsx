  ...
  const DB = {
    ...
    basic: {
      ...
      points: [
        ...
        { icon: '⚖️', color: '#B8953A', title: '혈당 조절 — 탄수화물 분해효소 억제 연구', body: 'α-글루코시다제 IC₅₀ 0.09 μM (아카보스 표적 효소와 관련된 전임상 지표). 식후 혈당 반응 및 인슐린 신호 관련 전임상 지표가 보고되어 있습니다.' },
    ...
    brain: {
      ...
      points: [
        ...
        { icon: '🛡️', color: '#10B981', title: '뇌 신경 염증 억제 — 미세아교세포 과활성 차단', body: '뇌 내 면역세포(미세아교세포) 과활성과 신경 독성 사이토카인 관련 지표가 전임상에서 보고되었습니다(Phytotherapy Research 2019).' },
      ],
    ...
    cardiovascular: {
      ...
      points: [
        ...
        { icon: '🛡️', color: '#10B981', title: '혈관 염증 억제 — ICAM-1·VCAM-1 접착분자 차단', body: '혈관 벽 백혈구 접착과 ICAM-1 관련 지표가 보고되었습니다(Nutrients 2022). 혈관 내부 만성 염증 연구로 해석해야 합니다.' },
      ],
    ...
    skin: {
      ...
      points: [
        ...
        { icon: '☀️', color: '#0A9BAD', title: 'DNA 광손상 58% 차단 — 세포 내부에서 UV 방어', body: 'UVB 자외선에 의한 DNA 광손상(CPD 형성)을 58% 억제(Antioxidants 2024). 선크림이 외부를 막는다면, 플로로탄닌은 세포 내부 DNA 손상 관련 지표 연구에서 다뤄집니다.' },
    ...
    cancer: {
      ...
      points: [
        { icon: '⚔️', color: '#10B981', title: '암세포주 모델의 아포토시스 지표 — 정상세포 보호 지표도 함께 보고', body: '췌장암·유방암·대장암·간암 세포에서 미토콘드리아 경로 아포토시스(세포사멸)를 유도합니다. 정상 세포 독성은 제한적이었다는 세포주 연구가 있습니다(Antioxidants 2023). Bax/Bcl-2 비율 조절이 핵심 기전.' },
        { icon: '🛡️', color: '#0A9BAD', title: 'Nrf2 경로 활성화 — 세포 방어막 최대로 높이다', body: '세포의 마스터 항산화 스위치 Nrf2를 활성화해 해독 효소(HO-1, NQO1, GST)를 유도합니다. 세포 내 DNA 산화 손상을 관련 경로 조절해 세포 손상 관련 초기 연구 지표로 해석해야 합니다.' },
    ...
    combo_all: {
      ...
      points: [
        ...
        { icon: '🛡️', color: '#10B981', title: '면역·항암 — NK세포 활성 + Nrf2 경로 + 선택적 아포토시스', body: 'NK세포 활성화·세포 방어막 강화·이상세포 선택적 제거 3중 면역 방어. 정상세포 보호 지표도 함께 보고하면서 이상세포만 제거.' },
    ...
    combo_neuro: {
      ...
      points: [
        ...
        { icon: '🛡️', color: '#10B981', title: '미세아교세포 과활성 차단 — 뇌 신경 보호', body: '뇌 내 면역세포 과활성과 신경 독성 사이토카인 관련 지표가 보고되었습니다. 인지 문제는 의료진 평가가 우선입니다.' },
      ],
    ...
    combo_beauty: {
      ...
      points: [
        ...
        { icon: '☀️', color: '#0A9BAD', title: 'DNA 광손상 58% 차단 + 항산화 연구 지표', body: 'UVB 자외선에 의한 DNA 광손상 58% 억제. 비타민C 대비 10~15배 강한 DPPH 항산화로 세포 산화 노화 전방위 차단(Antioxidants 2024).' },
    ...
    cardiovascular_2: {
      ...
      points: [
        ...
        { icon: '🛡️', color: '#0A9BAD', title: 'ICAM-1·VCAM-1 46% 억제 — 혈관 벽 면역 침윤 차단', body: '혈관 벽 면역세포 접착과 ICAM-1 관련 지표가 보고되었습니다(Nutrients 2022). 염증성 동맥경화 연구로 해석해야 합니다.' },
    ...
    cancer_2: {
      ...
      points: [
        ...
        { icon: '🛡️', color: '#0A9BAD', title: 'Nrf2 경로 — 정상세포 방어막 최대화', body: '세포 마스터 항산화 Nrf2를 활성화해 항암제·방사선으로부터 정상 세포를 보호. 해독 효소(HO-1, NQO1) 유도로 치료 중 산화 스트레스 관련 보조 연구 지표.' },
        { icon: '⚔️', color: '#7C3AED', title: '암세포주 모델의 아포토시스 지표 — 정상세포 보호 관련 전임상 지표', body: '췌장암·유방암·대장암·간암 세포에서 선택적 아포토시스 유도. Bax/Bcl-2 비율 조절. 정상 세포 독성은 제한적이었다는 세포주 연구가 있습니다(Antioxidants 2023).' },
    ...
    cancer_all: {
      ...
      points: [
        ...
        { icon: '⚔️', color: '#065F46', title: '연구 축 ③ 면역저하 — 면역 감시 관련 지표', body: 'NK세포 활성 향상으로 하루 수천 개 생기는 이상 세포 감시와 관련된 면역 지표를 관찰. Nrf2 활성화로 세포 자체 방어막 최대화. 면역 감시망이 촘촘해지면 암 종류와 무관하게 면역 감시 지표를 해석하는 데 참고됩니다.' },
    ...
    cancer_combo_2: {
      ...
      points: [
        ...
        { icon: '⚔️', color: '#7C3AED', title: '암세포주 모델의 아포토시스 지표 — 항암 보조 연구 지표', body: 'Bax/Bcl-2 비율 조절로 암세포에서만 아포토시스 유도. 항암제의 종양 세포 사멸 효과를 천연 성분으로 보조. 정상세포 보호 지표도 함께 보고(Antioxidants 2023).' },
