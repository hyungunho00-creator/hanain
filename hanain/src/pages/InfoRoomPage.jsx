...
const MATERIALS_CANCER = [
  { id:'cancer_all',     icon:Ribbon,     badge:'모든암통합', badgeColor:'#7C2D12', title:'모든 암 통합 전단지 — 암은 하나의 몸에서 온다', subtitle:'암 종류 무관, 모든 암에 공통 적용되는 핵심 원리', desc:'암 관련 연구에서 반복되는 산화·염증·면역저하·혈관신생 축을 교육용으로 정리했습니다.', pages:'A4 2장', category:'cancer_all',     color:'#7C2D12' },
  { id:'cancer_combo_1', icon:ShieldPlus, badge:'세포보호',     badgeColor:'#059669', title:'세포 보호·면역 연구 전단지',    subtitle:'암 가족력 등으로 세포 보호 정보를 찾는 분께 드리세요',  desc:'활성산소·Nrf2 세포방어·NK세포·암세포주 연구 지표를 교육용으로 정리했습니다.',  pages:'A4 2장', category:'cancer_combo_1', color:'#059669' },
...
const MATERIALS_RECOVERY = [
  ...
  { id:'recovery_2', icon:Sprout,    badge:'노화역행',  badgeColor:'#7C3AED', title:'노화 관리·세포 재생 전단지',              subtitle:'세포부터 젊어지고 싶은 분, 안티에이징이 목표인 분께',  desc:'Nrf2, 미토콘드리아, 자가포식, inflammaging 관련 연구 지표를 교육용으로 정리했습니다.',  pages:'A4 2장', category:'recovery_2', color:'#7C3AED' },
]
...
const MATERIALS_SINGLE = [
  ...
  { id:'brain_2',        icon:Brain,     badge:'뇌②',    badgeColor:'#7C3AED', title:'뇌 건강·수면 전단지 ②',       subtitle:'수면·인지 건강 관리에 집중',          desc:'글림파틱 순환, GABA 관련 연구, 수면 중 노폐물 처리 개념을 수면 중심으로 정리했습니다.',       pages:'A4 2장', category:'brain_2',        color:'#7C3AED' },
  ...
  { id:'inflammation',   icon:Flame,     badge:'염증①',  badgeColor:'#F97316', title:'만성염증·관절 전단지 ①',      subtitle:'몸이 늘 아프고 피곤한 분께',           desc:'NF-κB·NLRP3, CRP, 관절 연골 보호와 통증 관련 연구 지표를 정리했습니다.',       pages:'A4 2장', category:'inflammation',   color:'#F97316' },
  ...
  { id:'cancer',         icon:Shield,    badge:'면역①',  badgeColor:'#10B981', title:'면역·항산화 전단지 ①',        subtitle:'몸의 방어력을 높이고 싶은 분께',       desc:'NK세포, Nrf2 경로, 암세포주 아포토시스 지표, 항산화 연구를 정리했습니다.',        pages:'A4 2장', category:'cancer',         color:'#10B981' },
  ...
  { id:'gut',            icon:Microscope,badge:'장건강①', badgeColor:'#06B6D4', title:'장건강·마이크로바이옴 전단지 ①', subtitle:'소화·장 건강 걱정되는 분께',         desc:'Akkermansia, 장 장벽, LPS, 장-전신 염증 관련 연구 지표를 정리했습니다.', pages:'A4 2장', category:'gut',            color:'#06B6D4' },
    ...
    <div style={{ minHeight: '100vh', paddingTop: 64, background: '#F4F6F9', fontFamily: "'Noto Sans KR','Apple SD Gothic Neo',sans-serif" }}>
      ...
      <div style={{ maxWidth: 800, margin: '24px auto 0', padding: '0 14px' }}>
        <div style={{
          ...
          <strong style={{ color: NAVY }}>신뢰성 안내</strong>
          {' '}이 자료실의 전단지는 교육용 연구 요약입니다. 특정 질병의 예방·치료 효능을 보증하지 않으며,
          질환이 있거나 약물을 복용 중인 경우 의료진 상담과 검사 기록을 우선으로 판단해야 합니다.
        </div>
      </div>
      ...
      <div style={{ maxWidth: 800, margin: '32px auto 0', padding: '0 14px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 13, color: '#888', margin: '3px 0 0' }}>우리 몸은 하나다 · 결국 회복이다 — 전신 회복·노화 관리가 목표인 분께 드리세요</p>
          </div>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto 80px', padding: '0 14px' }}>
        <div style={{ background: '#fff', borderRadius: 14, border: '1.5px solid #e0e8f0', padding: '20px 24px' }}>
          ...
          {[
            ...
            { Icon: AlertTriangle,  title: '주의',                    desc: '이 자료는 교육 목적의 연구 정보입니다. 질병의 예방·치료 효능을 보증하지 않습니다.' },
          ].map(({ Icon, title, desc }) => (
...
function getContent(cat) {
  const DB = {
    ...
    basic: {
      ...
      points: [
        { icon: '', color: '#0A9BAD', title: '항산화 — 해양 폴리페놀 연구 지표', body: 'DPPH 라디칼 소거 IC₅₀ 0.06 mg/mL. 세포 DNA·지질·단백질 산화 손상을 전방위 차단. 노화의 근본 원인인 산화스트레스를 기전 수준에서 억제합니다.' },
        ...
        { icon: '', color: '#B8953A', title: '혈당 조절 — 탄수화물 분해효소 억제 연구', body: 'α-글루코시다제 IC₅₀ 0.09 μM (아카보스 표적 효소와 관련된 전임상 지표). 식후 혈당 반응 및 인슐린 신호 관련 전임상 지표가 보고되어 있습니다.' },
        { icon: '', color: '#8B5CF6', title: '뇌 보호 — 혈뇌장벽 통과, BACE1·Aβ 이중 차단', body: '알츠하이머 관련 베타아밀로이드 단백질 생성 효소 BACE1 억제 + Aβ42 응집 62% 차단(Marine Drugs, 2021). 혈뇌장벽 관련 전임상 가능성이 보고된 해양 폴리페놀.' },
        { icon: '', color: '#10B981', title: '세포 선택적 보호 — 정상세포 보호·이상세포 제거', body: 'Nrf2 경로로 정상 세포 방어막을 높이고, 암세포에서만 선택적으로 미토콘드리아 아포토시스를 유도(Antioxidants, 2023).' },
      ],
      ...
      compare: [
        { left: '비타민 → 단일 영양 보충, 항산화 약함', right: '플로로탄닌 → 항산화 지표 + 다중 기전 연구' },
        { left: '오메가-3 → 항염증 보조, 흡수율 불안정', right: '플로로탄닌 → NF-κB·NLRP3 염증 경로 연구' },
    ...
    diabetes: {
      ...
      points: [
        { icon: '', color: '#DC2626', title: 'α-글루코시다제·아밀라아제 이중 억제 — 탄수화물 분해효소 억제 연구', body: '탄수화물을 포도당으로 분해하는 두 효소를 동시에 억제. 아카보스의 표적인 α-글루코시다제 관련 억제 지표가 전임상 연구에서 보고되었습니다(IC₅₀ 0.09 μM, Marine Drugs 2022). 식후 혈당 관리는 식사·운동·복용약 계획과 함께 해석해야 합니다.' },
        { icon: '', color: '#F97316', title: '인슐린 저항성 개선 — IRS-1→PI3K→AKT 경로 직접 활성화', body: '인슐린 신호 전달 경로를 직접 켜서 세포가 포도당을 제대로 흡수하도록 합니다. 8주 투여 후 HOMA-IR 32% 개선(Marine Drugs 2022). 근육·간세포의 인슐린 감수성 관련 지표가 보고되었습니다.' },
        ...
        { icon: '', color: '#0A9BAD', title: '췌장 베타세포 보호 — 인슐린 생산 기관을 지키다', body: '인슐린을 만드는 췌장 베타세포는 산화 스트레스에 가장 취약한 세포입니다. 플로로탄닌의 항산화 지표와 베타세포 보호 가능성이 전임상 연구에서 다뤄집니다.' },
      ...
      compare: [
        { left: '식이조절만 → 효과 제한적, 지속 어려움', right: '플로로탄닌 → 효소 단계에서 탄수화물 분해 속도 조절 가능성' },
        { left: '운동만 → 근육 인슐린 감수성만 개선', right: '플로로탄닌 → 간·근육·장 인슐린 신호 전체 개선' },
        { left: '당뇨약(아카보스) → 단일 효소만 억제', right: '플로로탄닌 → 2가지 효소 관련 전임상 지표, 의약품 대체 아님' },
    ...
    brain: {
      ...
      intro: '잠을 자는 동안 뇌는 하루 쌓인 독성 단백질(베타아밀로이드)을 청소합니다. 수면이 나빠지면 이 청소가 실패하고, 독소가 쌓이면서 기억력 저하 위험이 커질 수 있습니다. 플로로탄닌은 혈뇌장벽 관련 전임상 가능성을 바탕으로 뇌 내부에서 알츠하이머의 두 핵심 단계를 모두 차단하는 몇 안 되는 천연 성분입니다.',
      timeline: [
      ...
      points: [
        { icon: '', color: '#7C3AED', title: 'BACE1 억제 — 베타아밀로이드 생성 경로 연구', body: '베타아밀로이드를 만드는 효소 BACE1을 IC₅₀ 29.4 μM로 억제(Marine Drugs 2021). 베타아밀로이드 생성 경로와 관련된 전임상 연구 지표입니다. 질병 치료를 의미하지 않습니다.' },
        { icon: '', color: '#0A9BAD', title: 'Aβ42 응집 62% 차단 — 베타아밀로이드 응집 지표 연구', body: '이미 생성된 베타아밀로이드가 뭉쳐 플라크 관련 응집체를 형성하는 과정을 62% 억제(Marine Drugs 2021). 생성·응집 경로를 함께 보는 전임상 연구로 해석해야 합니다.' },
        { icon: '', color: '#EC4899', title: 'GABA-A 수용체 활성 — 수면 질 관련 전임상 지표', body: 'GABA-A 수용체에 결합해 진정·이완 효과를 냅니다. 생쥐 수면 모델에서 NREM 수면 시간 유의미하게 연장(Marine Drugs 2021). 수면제 등 의약품을 대체하지 않는 범위에서 수면 위생과 함께 해석해야 합니다.' },
        { icon: '', color: '#F97316', title: 'AChE 억제 — 기억·학습 신경전달물질을 보존', body: '아세틸콜린 분해 효소(AChE)를 억제해 기억·학습을 담당하는 신경전달물질 농도를 높입니다. AChE 경로와 관련된 전임상 지표입니다. 인지 기능 문제는 의료진 평가가 우선입니다.' },
        { icon: '', color: '#10B981', title: '뇌 신경 염증 억제 — 미세아교세포 과활성 차단', body: '뇌 내 면역세포(미세아교세포) 과활성과 신경 독성 사이토카인 관련 지표가 전임상에서 보고되었습니다(Phytotherapy Research 2019).' },
      ],
      refs: ['Ahn G et al. Marine Drugs 2021', 'Park S et al. Marine Drugs 2021 수면', 'Ahn G et al. Phytotherapy Research 2019'],
      systemMsg: '뇌 건강은 수면 → 염증 → 혈당 → 혈압과 모두 연결됩니다.\n플로로탄닌은 뇌를 포함한 전신 시스템 지표를 함께 살피는 관점입니다.',
      p2headline: '뇌 건강, 50대부터 지금 당장 시작해야 합니다',
      compare: [
        { left: '은행잎 → 혈류 개선만, Aβ 차단 없음', right: '플로로탄닌 → BACE1·Aβ 응집 관련 전임상 지표' },
        { left: '오메가-3 → 항염증 보조, 혈뇌장벽 통과 약함', right: '플로로탄닌 → 혈뇌장벽 관련 전임상 가능성, 뇌 내부 작용' },
        { left: '카페인 → 일시적 각성, 수면 방해', right: '플로로탄닌 → AChE 억제로 지속적 인지력 지원' },
        { left: '수면제 → 의존성·내성·뇌 청소 방해', right: '플로로탄닌 → GABA 자연 이완, 뇌 청소 시간 증가' },
      ],
      targets: ['건망증이 부쩍 심해진 40~70대', '잠들기 어렵고 새벽에 자주 깨는 분', '알츠하이머·치매 가족력이 있는 분', '집중력·기억력 저하가 걱정되는 분', '낮에 멍하고 머리가 안 도는 분', '뇌 건강을 미리 관리 정보를 찾는 분'],
    ...
    cardiovascular: {
      ...
      intro: '혈압약 복용 중에도 혈관 염증·생활습관 지표를 함께 보는 것이 중요합니다. 콜레스테롤 수치를 낮춰도 산화된 LDL이 혈관 벽에 쌓이면 막힙니다. 플로로탄닌은 혈압·콜레스테롤·혈관 내피·혈관 염증이라는 4가지 연구 축을 함께 설명하는 소재입니다.',
      timeline: [
      ...
      points: [
        { icon: '', color: '#E05050', title: 'ACE 억제 — 혈압 관련 ACE 경로 연구', body: '안지오텐신 전환효소(ACE)를 IC₅₀ 0.27 mg/mL로 억제(Marine Drugs 2020). ACE 경로 관련 전임상 연구 지표입니다. 혈압 관리는 처방약·생활습관·진료 계획과 함께 보아야 합니다.' },
        { icon: '', color: '#0A9BAD', title: 'eNOS/NO 경로 — 혈관 내피를 안에서부터 회복', body: '혈관을 이완시키는 산화질소(NO) 생성 효소 eNOS를 62% 활성화(Nutrients 2022). 혈관 내피세포 보호와 혈관 탄성 관련 지표가 보고되었습니다. 단순 수치 조절보다 생활·영양 기록과 함께 해석해야 합니다.' },
        { icon: '', color: '#B8953A', title: 'LDL 산화 차단 — 동맥경화의 진짜 원인 제거', body: 'LDL 콜레스테롤 수치보다 LDL의 산화가 동맥경화의 진짜 원인. 플로로탄닌의 항산화 지표가 LDL 산화와 죽상경화반 형성 과정 연구에서 다뤄집니다.' },
        { icon: '', color: '#F97316', title: 'HMG-CoA 환원효소 억제 — 콜레스테롤 합성 자체 억제', body: '간의 콜레스테롤 합성 효소(스타틴의 표적 HMG-CoA 환원효소)를 억제합니다. 총 콜레스테롤 24%·LDL 32% 감소(동물 모델, Nutrients 2019). 스타틴 표적과 같은 경로를 다룬 전임상 연구이며, 처방약 대체를 의미하지 않습니다.' },
        { icon: '', color: '#10B981', title: '혈관 염증 억제 — ICAM-1·VCAM-1 접착분자 차단', body: '혈관 벽 백혈구 접착과 ICAM-1 관련 지표가 보고되었습니다(Nutrients 2022). 혈관 내부 만성 염증 연구로 해석해야 합니다.' },
      ],
      ...
      p2headline: '혈압약·스타틴 복용 중에도 생활·영양 기록이 중요합니다',
      compare: [
        { left: '스타틴 → 콜레스테롤 수치만 낮춤', right: '플로로탄닌 → LDL 산화 차단 + 혈관 내피 회복까지' },
        { left: '혈압약 → 처방 목적에 따라 수치 관리', right: '플로로탄닌 → eNOS로 혈관 자체 탄성 회복' },
        { left: '오메가-3 → 중성지방만, LDL 산화 차단 약함', right: '플로로탄닌 → LDL 산화·ACE·염증·내피 동시 작용' },
        { left: '운동 → 혈류 개선, 혈관 내부 손상 회복 안 됨', right: '플로로탄닌 → 내피세포 분자 수준 복구' },
      ],
      targets: ['수축기 혈압 130 mmHg 이상인 분', 'LDL 콜레스테롤이 높다는 진단을 받은 분', '협심증·동맥경화 가족력이 있는 분', '혈압약·스타틴 복용 중 보완이 필요한 분', '뇌졸중·심근경색을 관리 정보를 찾는 분', '혈관 건강을 안에서부터 회복하고 싶은 분'],
    ...
    inflammation: {
      ...
      intro: '만성 저등급 염증은 당뇨·심장병·암·인지 건강과 함께 논의되는 공통 경로입니다. 플로로탄닌은 NF-κB와 NLRP3 관련 전임상 지표를 이해하는 교육용 소재입니다.',
      timeline: [
      ...
      points: [
        { icon: '', color: '#E05050', title: 'NF-κB 경로 억제 지표 — 염증의 마스터 스위치를 끄다', body: '염증 반응 전체를 지휘하는 NF-κB p65 핵 이전 억제 지표가 보고되었습니다. TNF-α 68%, IL-6 54%, NO 72% 억제(Marine Drugs 2021). 염증 매개 경로 관련 전임상 연구이며, 진통소염제를 대체한다는 의미는 아닙니다.' },
        ...
        { icon: '', color: '#10B981', title: 'COX-2·iNOS 억제 — 통증·붓기의 발생 경로 차단', body: '통증·발열·붓기를 유발하는 COX-2와 iNOS 발현을 억제합니다. COX-2·iNOS 발현 관련 전임상 연구이며, 진통소염제 대체 표현으로 해석하지 않아야 합니다.' },
      ],
      ...
      p2headline: '진통제로 덮지 말고, 염증의 불을 기전 수준에서 끄세요',
      compare: [
        { left: 'NSAIDs(이부프로펜) → COX-2만 억제, 위장 손상', right: '플로로탄닌 → NF-κB·NLRP3·COX-2 관련 전임상 지표' },
        { left: '스테로이드 → 강력하지만 의존성·부작용', right: '플로로탄닌 → 장기 관리 가능, 개인별 주의 필요' },
        { left: '글루코사민 → 연골 보충만, 염증 차단 없음', right: '플로로탄닌 → MMP 억제로 분해 자체 차단' },
        { left: '오메가-3 → 염증 해소 보조, 원인 차단 약함', right: '플로로탄닌 → 염증 생성 경로 관련 전임상 지표' },
      ],
    ...
    skin: {
      ...
      points: [
        ...
        { icon: '', color: '#B8953A', title: '티로시나제 억제 — 색소침착 관련 비교 지표', body: '멜라닌 합성 효소 티로시나제를 IC₅₀ 0.19 mg/mL로 억제(Food Chem Toxicol 2010). 코직산과 비교되는 티로시나제 억제 지표가 보고되었습니다. 잡티·기미·색소침착 관련 연구로 해석해야 합니다.' },
        { icon: '', color: '#0A9BAD', title: 'DNA 광손상 58% 차단 — 세포 내부에서 UV 방어', body: 'UVB 자외선에 의한 DNA 광손상(CPD 형성)을 58% 억제(Antioxidants 2024). 선크림이 외부를 막는다면, 플로로탄닌은 세포 내부 DNA 손상 관련 지표 연구에서 다뤄집니다.' },
        { icon: '', color: '#7C3AED', title: '5α-환원효소 억제 + KGF 증가 — 탈모 이중 케어', body: '탈모 원인 DHT를 만드는 5α-환원효소를 억제하고, 동시에 모유두 세포의 모발성장인자(KGF) 발현을 증가시킵니다(Marine Drugs 2020). 모발 관련 전임상 지표가 함께 보고된 이중 경로입니다.' },
      ...
      compare: [
        { left: '콜라겐 섭취 → 흡수 불확실, 분해 계속 진행', right: '플로로탄닌 → MMP 억제로 분해 효소 경로 조절 가능성' },
        { left: '비타민C → 단독 항산화, 미백·주름 효과 제한', right: '플로로탄닌 → 미백·주름·UV·모발 관련 연구 지표' },
        { left: '레티놀 → 피부 자극·발적·박피 가능', right: '플로로탄닌 → 개인별 반응 확인이 필요한 해양 폴리페놀 소재' },
        { left: '코직산 → 미백만, 주름·탈모 효과 없음', right: '플로로탄닌 → 미백·주름·모발 관련 연구 지표' },
      ],
    ...
    cancer: {
      ...
      accentLine: '암 위험 관리는 식이·생활 습관 기록부터 시작됩니다',
      intro: '면역 시스템은 하루에도 수천 개씩 생기는 이상 세포를 발견하고 제거합니다. 이 시스템이 약해지면 이상 세포가 살아남아 증식합니다. 플로로탄닌은 NK세포 활성화, Nrf2 항산화 방어막, 암세포주 선택성 지표 제거라는 3중 면역 방어 기전을 동시에 발휘합니다.',
      timeline: [
      ...
      points: [
        { icon: '', color: '#10B981', title: '암세포주 모델의 아포토시스 지표 — 정상세포 보호 지표도 함께 보고', body: '췌장암·유방암·대장암·간암 세포에서 미토콘드리아 경로 아포토시스(세포사멸)를 유도합니다. 정상 세포 독성은 제한적이었다는 세포주 연구가 있습니다(Antioxidants 2023). Bax/Bcl-2 비율 조절이 핵심 기전.' },
        { icon: '', color: '#0A9BAD', title: 'Nrf2 경로 활성화 — 세포 방어막 최대로 높이다', body: '세포의 마스터 항산화 스위치 Nrf2를 활성화해 해독 효소(HO-1, NQO1, GST)를 유도합니다. 세포 내 DNA 산화 손상을 관련 경로 조절해 세포 손상 관련 초기 연구 지표로 해석해야 합니다.' },
        ...
        { icon: '', color: '#B8953A', title: 'DPPH IC₅₀ 0.06 mg/mL — 항산화 연구 지표', body: '활성산소, DNA 손상, 세포 돌연변이 관련 연구에서 항산화 지표가 보고되었습니다. 수치 비교는 실험 조건 안에서 해석해야 합니다.' },
      ],
      ...
      compare: [
        { left: '비타민C → 일반 항산화, NK세포 활성 없음', right: '플로로탄닌 → Nrf2 활성 + NK세포 + 항산화 연구 지표' },
        { left: '버섯 추출물 → 면역 조절 보조', right: '플로로탄닌 → NK세포+아포토시스+VEGF 직접 작용' },
        { left: '셀레늄 → 항산화 보조, 단독 효과 제한', right: '플로로탄닌 → DNA 보호+혈관신생 억제+Nrf2 활성' },
        { left: '후코이단 → 면역 지지, 암세포주 지표 약함', right: '플로로탄닌 → 암세포주 선택성 지표, 정상세포 보호 관련 전임상 지표' },
      ],
    ...
    gut: {
      ...
      intro: '현대인의 과민성 장 증후군, 반복되는 소화불량, 이유 없는 복부 팽만. 이것은 단순히 소화 문제가 아닙니다. 장내 미생물 불균형은 혈당, 혈관 염증, 인지 컨디션, 피부 상태와 함께 논의됩니다. 플로로탄닌은 장-전신 연결 고리를 연구 관점에서 정리합니다.',
      timeline: [
      ...
      points: [
        ...
        { icon: '', color: '#0A9BAD', title: '장 투과성 42% 감소 — 장 장벽 관련 전임상 지표', body: '타이트 정션 단백질(Occludin, Claudin) 발현을 높여 장 점막 장벽을 강화합니다. 장 투과성 42% 감소(Nutrients 2024). 장 장벽·LPS 노출 관련 지표로 해석합니다.' },
        { icon: '', color: '#10B981', title: '혈중 LPS 35% 감소 — 전신 만성 염증 관련 지표', body: '장에서 혈류로 유입되는 세균 내독소(LPS)를 35% 낮춥니다. 대사성 내독소혈증이 해소되면 혈당·체중·혈압·인지 관련 지표를 함께 관찰하는 연구로 해석해야 합니다.' },
        { icon: '', color: '#B8953A', title: '프리바이오틱 효과 — 유익균의 먹이가 되다', body: '소화되지 않은 플로로탄닌이 대장에서 유익균의 발효 기질로 작용합니다. 단쇄지방산(부티레이트) 생성과 장 점막 에너지 대사 관련 지표가 보고됩니다.' },
        { icon: '', color: '#E05050', title: 'NLRP3·NF-κB 이중 차단 — 장 염증 경로 연구', body: '과민성 장 증후군·염증성 장질환의 핵심 경로 NLRP3와 NF-κB를 동시에 억제합니다. 장 점막 염증 경로와 복통·팽만·설사 같은 증상 기록을 함께 보는 연구로 해석합니다(Marine Drugs 2023).' },
      ],
    ...
    combo_all: {
      ...
      points: [
        { icon: '', color: '#0A9BAD', title: '항산화 — 해양 폴리페놀 연구 지표', body: 'DPPH 라디칼 소거 IC₅₀ 0.06 mg/mL. 세포 DNA·지질·단백질 산화 손상 전방위 차단. 노화의 근본 원인인 산화스트레스를 기전 수준에서 억제합니다.' },
        { icon: '', color: '#DC2626', title: '혈당 조절 — α-글루코시다제 관련 전임상 지표', body: '식후 혈당 반응 관련 경로 조절 가능성 + 인슐린 저항성 개선 + 공복혈당 조절. 3중 혈당 관리 기전으로 당뇨 전단계부터 관리합니다.' },
        { icon: '', color: '#E05050', title: '심혈관 — ACE 억제 + eNOS 활성 + LDL 산화 차단', body: '혈압 조절·혈관 내피 회복·동맥경화 예방 3중 기전. 수치만 낮추는 것이 아닌 혈관 자체를 안에서부터 회복합니다.' },
        { icon: '', color: '#7C3AED', title: '뇌·수면 — BACE1 억제 + GABA 활성', body: '알츠하이머 독소 생성 관련 경로 조절 + 수면의 질 자연 회복. 혈뇌장벽 관련 전임상 가능성이 보고된 해양 폴리페놀.' },
        { icon: '', color: '#10B981', title: '면역·항암 — NK세포 활성 + Nrf2 경로 + 선택적 아포토시스', body: 'NK세포 활성화·세포 방어막 강화·이상세포 선택적 제거 3중 면역 방어. 정상세포 보호 지표도 함께 보고하면서 이상세포만 제거.' },
    ...
    combo_meta: {
      urgency: '혈당과 혈압은 함께 기록해야 합니다 — 대사증후군은 연결된 지표입니다',
      headline: ['혈당이 높으면 혈관이 망가지고', '혈관이 망가지면 심장과 뇌가', '동시에 위험해집니다'],
      accentLine: '대사증후군 — 혈당·혈압·콜레스테롤·복부비만 4가지가 함께 옵니다',
      intro: '혈당이 높으면 혈관 내피가 손상됩니다. 손상된 혈관에 콜레스테롤이 쌓이고 혈압이 오릅니다. 심근경색·뇌졸중·신부전·실명은 모두 같은 기전 수준에서 출발합니다. 플로로탄닌은 혈당·혈관·콜레스테롤 세 경로를 동시에 공략해 대사증후군의 연쇄를 끊습니다.',
      timeline: [
      ...
      points: [
        { icon: '', color: '#DC2626', title: '혈당 — 탄수화물 분해효소 관련 전임상 연구', body: '식후 혈당 반응 관련 경로 조절 가능성. IRS-1→PI3K→AKT 인슐린 신호 직접 활성화. 공복혈당 평균 9.2 mg/dL 감소(Nutrients 2023 메타분석).' },
        { icon: '', color: '#E05050', title: '혈압 — ACE 경로 관련 전임상 연구', body: 'ACE IC₅₀ 0.27 mg/mL 억제. 혈관 수축·eNOS 관련 전임상 지표가 보고되었습니다(Marine Drugs 2020). 혈압약 대체 표현으로 해석하지 않아야 합니다.' },
        { icon: '', color: '#B8953A', title: '콜레스테롤 — HMG-CoA 환원효소 억제 (스타틴 동일 기전)', body: '총 콜레스테롤 24%·LDL 32% 감소(동물 모델). LDL 산화까지 차단해 동맥경화반 형성 관련 경로 억제 지표.' },
    ...
    combo_neuro: {
      ...
      accentLine: '뇌 염증(neuroinflammation) — 인지·기분·신경 건강에서 반복되는 연구 축',
      intro: '만성 저등급 염증은 혈뇌장벽을 뚫고 뇌 속 미세아교세포를 과활성화합니다. 신경이 파괴되고, 수면이 망가지고, 기억력 저하 위험이 커질 수 있습니다. 플로로탄닌은 전신 염증을 기전 수준에서 끄면서 동시에 혈뇌장벽을 통과해 뇌 내부를 직접 보호하는 이중 작용을 합니다.',
      timeline: [
      ...
      points: [
        { icon: '', color: '#F97316', title: 'NF-κB·NLRP3 이중 차단 — 전신 염증 마스터 스위치 OFF', body: 'TNF-α 68%, IL-6 54%, IL-1β 74% 억제. 만성 염증의 두 핵심 경로를 동시에 차단해 뇌·관절·혈관 염증을 기전 수준에서 끕니다(Marine Drugs 2021/2023).' },
        { icon: '', color: '#7C3AED', title: 'BACE1 억제 + Aβ 응집 62% 억제 — 베타아밀로이드 관련 전임상 지표', body: '베타아밀로이드 관련 노폐물 생성 효소 억제 + 이미 생성된 아밀로이드 응집 62% 차단. 혈뇌장벽을 직접 통과, 뇌 내부에서 작용합니다.' },
        ...
        { icon: '', color: '#10B981', title: '미세아교세포 과활성 차단 — 뇌 신경 보호', body: '뇌 내 면역세포 과활성과 신경 독성 사이토카인 관련 지표가 보고되었습니다. 인지 문제는 의료진 평가가 우선입니다.' },
      ],
    ...
    combo_immune: {
      ...
      points: [
        ...
        { icon: '', color: '#0A9BAD', title: '장 투과성 42% 감소 — 장 장벽 관련 전임상 지표', body: '타이트 정션 단백질 발현 강화로 장벽 42% 개선. 독소·세균이 혈류로 새는 것을 차단 → 전신 염증·면역 교란 해소.' },
        { icon: '', color: '#10B981', title: 'NK세포 활성 + Nrf2 경로 — 면역 감시 최대 강화', body: 'NK세포가 이상 세포를 발견·제거하는 능력 강화. Nrf2로 세포 방어막 최대화. 항암 치료 중 면역 기능 유지에도 도움.' },
        { icon: '', color: '#B8953A', title: '혈중 LPS 35% 감소 — 대사성 내독소혈증 해소', body: '장에서 혈류로 유입되는 세균 내독소 35% 감소. 대사성 내독소혈증이 해소되면 혈당·혈압·뇌 기능이 연쇄 개선.' },
        { icon: '', color: '#E05050', title: 'NLRP3·NF-κB 이중 지표 — 장·전신 염증 경로 연구', body: '과민성 장 증후군·염증성 장질환 관련 경로 연구입니다. 복통·팽만·설사 기록은 진료 상담과 함께 해석해야 합니다.' },
      ],
    ...
    combo_beauty: {
      ...
      accentLine: '피부 노화의 3대 연구 축: MMP 분해 + 멜라닌 축적 + DHT 모낭 약화',
      intro: '콜라겐을 먹어도 MMP 효소가 분해하면 소용없습니다. 미백 크림을 발라도 멜라닌을 만드는 효소가 활성화되면 잡티는 계속 생깁니다. 탈모를 막으려면 DHT 생성 효소를 억제해야 합니다. 플로로탄닌은 피부·모발 노화 관련 세 경로를 연구 관점에서 설명하는 해양 폴리페놀 소재입니다.',
      timeline: [
      ...
      points: [
        { icon: '', color: '#EC4899', title: 'MMP-1 콜라게나제 68% 억제 — 주름 생성 효소 관련 경로 조절', body: '자외선·활성산소가 활성화하는 콜라겐 분해 효소 MMP-1 68% 억제(Marine Drugs 2012). 콜라겐을 먹는 것보다 분해를 막는 것이 효율적일 수 있음. 탄력 관련 지표 관리.' },
        { icon: '', color: '#B8953A', title: '티로시나제 억제 — 색소침착 관련 비교 지표', body: '멜라닌 합성 효소 티로시나제 IC₅₀ 0.19 mg/mL 억제. 코직산과 비교되는 티로시나제 억제 지표가 보고되었습니다(Food Chem Toxicol 2010). 색소침착 관련 연구로 해석해야 합니다.' },
        { icon: '', color: '#7C3AED', title: '5α-환원효소 억제 + KGF 증가 — 탈모 이중 케어', body: 'DHT를 만드는 5α-환원효소 억제 + 모유두 세포 성장인자(KGF) 증가. 모발 관련 경로 관리 지표(Marine Drugs 2020).' },
        { icon: '', color: '#0A9BAD', title: 'DNA 광손상 58% 차단 + 항산화 연구 지표', body: 'UVB 자외선에 의한 DNA 광손상 58% 억제. 비타민C 대비 10~15배 강한 DPPH 항산화로 세포 산화 노화 전방위 차단(Antioxidants 2024).' },
      ...
      compare: [
        ...
        { left: '탈모약(피나스테리드) → 부작용, 단독 효소만', right: '플로로탄닌 → 5α-환원효소+KGF 이중, 개인별 주의 필요' },
    ...
    basic_2: {
      ...
      points: [
        ...
        { icon: '', color: '#10B981', title: 'Nrf2 마스터 스위치 — 세포가 스스로 방어막을 세운다', body: '세포 내 마스터 항산화 전사인자 Nrf2를 직접 활성화. HO-1·NQO1·GST 해독 효소 군을 유도해 세포 자체의 방어 능력을 최대화합니다. 외부 주입이 아닌 내부 강화.' },
        { icon: '', color: '#B8953A', title: '항산화 연구 지표 — DPPH·ABTS 복수 지표 모두 1위', body: 'DPPH 라디칼 소거 IC₅₀ 0.06 mg/mL, ABTS 항산화 지수도 비타민C·E·레스베라트롤 대비 10~15배. 단일 수치가 아닌 복수 항산화 지표 전체에서 최상위.' },
    ...
    diabetes_2: {
      ...
      points: [
        { icon: '', color: '#DC2626', title: 'AGEs(최종당화산물) 생성 억제 — 합병증의 핵심 원인 차단', body: '혈당이 높으면 포도당이 단백질·지질과 결합해 AGEs를 만듭니다. 이 당화 산물이 혈관·신장·눈·신경을 파괴합니다. 플로로탄닌의 항산화 지표와 AGEs 생성 관련 연구가 보고되었습니다.' },
        { icon: '', color: '#7C3AED', title: '망막 혈관 보호 — 당뇨 실명을 예방하는 기전', body: '당뇨망막병증은 미세혈관 출혈·VEGF 과발현이 원인. 플로로탄닌의 VEGF 억제 + 항산화력으로 망막 혈관을 보호합니다. 시력 보호의 핵심 기전.' },
        ...
        { icon: '', color: '#0A9BAD', title: '말초신경 보호 — 손발 저림·통증 완화 기전', body: '당뇨 신경병증은 미세혈관 산화 손상 + 신경 직접 글리케이션이 원인. 항산화 지표와 신경 보호 가능성이 연구됩니다. 손발 저림·통증은 의료진 평가가 우선입니다.' },
        { icon: '', color: '#E05050', title: '심혈관 합병증 예방 — 당뇨+혈관 이중 차단', body: '당뇨 환자의 심근경색 위험은 정상인의 2~4배. ACE 억제 + eNOS 활성 + LDL 산화 차단으로 혈관 합병증 위험을 동시에 낮춥니다.' },
      ],
      ...
      targets: ['당뇨 진단 후 합병증이 걱정되는 분', '손발 저림·시력 저하가 시작된 분', '혈당약 복용 중 합병증 관리 정보가 필요한 분', '당화혈색소(HbA1c) 7% 이상인 분', '신장·눈·심장 동반 관리가 필요한 당뇨 환자', '당뇨 가족력 있는 40~70대 예방 관리군'],
    ...
    brain_2: {
      ...
      intro: '수면은 단순한 휴식이 아닙니다. 잠자는 동안 뇌는 글림파틱 시스템(뇌척수액 순환)을 통해 하루 쌓인 베타아밀로이드·타우 단백질 독소를 청소합니다. 수면이 망가지면 이 청소가 실패하고, 10년 후 치매로 이어집니다. 플로로탄닌은 수면 질 관련 전임상 지표하면서 동시에 뇌 노폐물 생성 자체를 차단합니다.',
      timeline: [
      ...
      points: [
        { icon: '', color: '#7C3AED', title: 'GABA-A 수용체 활성 — 뇌가 스스로 이완하는 기전', body: '신경 억제 수용체 GABA-A에 직접 결합해 진정·이완. NREM 수면(깊은 수면) 시간 유의미하게 연장(Marine Drugs 2021). 수면제 등 의약품을 대체하지 않는 범위의 수면 관리.' },
        { icon: '', color: '#0A9BAD', title: '글림파틱 청소 시간 확보 — 베타아밀로이드 관련 노폐물 배출 극대화', body: '깊은 수면 시간이 늘어나면 뇌척수액 순환(글림파틱) 활성화 → 베타아밀로이드·타우 단백질 배출 극대화. 수면 개선 자체가 인지 건강 관리의 중요한 축입니다.' },
        { icon: '', color: '#EC4899', title: 'BACE1 억제 — 자는 동안도 독소 생성 관련 경로 조절', body: 'BACE1 관련 억제 지표와 수면 중 노폐물 처리 개념을 함께 설명합니다. 뇌 노폐물을 양방향에서 관리한다는 표현은 연구 가설 범위로 보아야 합니다.' },
        { icon: '', color: '#F97316', title: 'AChE 억제 — 기억·학습 신경전달물질 보존', body: '아세틸콜린 분해 효소 억제 → 기억·학습 담당 아세틸콜린 농도 유지. AChE 경로와 관련된 전임상 지표입니다. 인지 기능 문제는 의료진 평가가 우선입니다.' },
      ...
      systemMsg: '수면 → 뇌 청소 → 독소 배출 → 인지력 보존\n수면의 질을 올리는 것이 인지 건강 관리의 중요한 축입니다.',
      p2headline: '수면·인지 건강은 의료진 상담과 함께 관리하세요',
      compare: [
      ...
      targets: ['잠들기 어렵고 새벽에 자주 깨는 분', '알츠하이머·인지 건강 관리가 필요한 분', '수면제 복용 여부를 상담해 보고 싶은 분', '낮에 멍하고 집중력이 떨어지는 분', '치매 가족력 + 수면 문제가 동시에 있는 분', '50~70대 수면·인지 동반 관리가 필요한 분'],
    ...
    cardiovascular_2: {
      ...
      intro: '혈압을 관리하는 중에도 산화 LDL 등 혈관 지표를 함께 보면 동맥이 굳습니다. 스타틴으로 LDL 수치를 낮춰도 LDL 산화가 계속되면 죽상경화반은 자랍니다. 진짜 혈관 건강은 내피세포 기능 회복, LDL 산화 차단, 혈관 염증 억제 세 가지가 동시에 이뤄져야 합니다.',
      timeline: [
      ...
      points: [
        ...
        { icon: '', color: '#B8953A', title: 'LDL 산화 차단 — 동맥경화의 진짜 원인 제거', body: 'LDL 수치보다 LDL 산화가 동맥경화의 진짜 원인. 플로로탄닌의 항산화 연구 지표력이 LDL 산화를 관련 경로 조절. 죽상경화반 형성·성장 억제.' },
        { icon: '', color: '#0A9BAD', title: 'ICAM-1·VCAM-1 46% 억제 — 혈관 벽 면역 침윤 차단', body: '혈관 벽 면역세포 접착과 ICAM-1 관련 지표가 보고되었습니다(Nutrients 2022). 염증성 동맥경화 연구로 해석해야 합니다.' },
        { icon: '', color: '#7C3AED', title: 'ACE 억제 + HMG-CoA 억제 — 이중 약물 기전 천연 대안', body: 'ACE·HMG-CoA 관련 전임상 지표가 함께 보고된 소재입니다. 처방약을 대체하지 않고 의료진 상담 범위에서 해석해야 합니다.' },
      ...
      p2headline: '혈압약·스타틴·아스피린 복용 중에는 보조식품도 상담하세요',
      compare: [
      ...
      targets: ['심근경색·뇌졸중 가족력이 있는 분', '혈압약·스타틴을 보완하고 싶은 분', '동맥경화 진단 또는 의심이 있는 분', '혈관 초음파에서 내막 두께 증가 소견을 받은 분', '협심증·부정맥 관리 정보가 필요한 분', '50~70대 혈관 재생·플라크 감소를 원하는 분'],
    ...
    inflammation_2: {
      ...
      points: [
        { icon: '', color: '#F97316', title: 'NLRP3 인플라마솜 억제 — 자가면역 공통 핵심 경로 차단', body: '류마티스 관절염·통풍·NASH·2형 당뇨·알츠하이머의 공통 염증 경로 NLRP3 억제. IL-1β 74%, 카스파제-1 67% 감소(Marine Drugs 2023). 여러 신약 연구에서 다루는 표적입니다.' },
        { icon: '', color: '#E05050', title: 'NF-κB 경로 억제 지표 — 자가면역 면역세포 과활성 OFF', body: '자가면역에서 과활성화된 T세포·대식세포를 지휘하는 NF-κB를 차단. TNF-α 68%, IL-6 54% 억제. 면역세포 과활성 없이 항원 인식 능력은 유지.' },
        { icon: '', color: '#0A9BAD', title: 'MMP-3/13 억제 — 관절 연골·뼈 침식 차단', body: '류마티스 관련 연골·뼈 침식 경로에서 MMP-3, MMP-13 억제 지표가 보고되었습니다. 표준치료를 대체하지 않습니다.' },
      ...
      systemMsg: '자가면역 → 핵심 염증 경로 차단 → 면역 균형 회복\n스테로이드 등 처방약을 대체하지 않는 범위에서 염증 경로 연구로 해석해야 합니다.',
      ...
      compare: [
        ...
        { left: '메토트렉세이트 → 면역억제, 간 독성 위험', right: '플로로탄닌 → 개인별 주의가 필요한 전임상 연구 소재' },
        { left: '오메가3 → 항염 보조, NLRP3 직접 억제 없음', right: '플로로탄닌 → NLRP3·NF-κB 관련 전임상 지표' },
      ],
      targets: ['류마티스 관절염 진단을 받은 분', '통풍 발작이 반복되는 분', '건선·루푸스 등 자가면역 질환이 있는 분', '스테로이드 복용 전 주의점을 확인하려는 분', '관절이 붓고 아침 뻣뻣함이 심한 분', 'CRP·ESR 수치가 높은 만성 염증 환자'],
    ...
    skin_2: {
      ...
      intro: '40~50대 이후 에스트로겐이 감소하면 DHT(남성 호르몬)가 상대적으로 강해지고, 콜라겐 합성이 줄어들며, 멜라닌 침착이 빨라집니다. 이 3가지 경로가 동시에 피부·모발을 공격합니다. 플로로탄닌은 DHT 생성, MMP, 티로시나제 관련 경로를 연구 관점에서 설명하는 소재입니다.',
      timeline: [
      ...
      points: [
        { icon: '', color: '#EC4899', title: '5α-환원효소 억제 — 호르몬성 탈모 관련 경로 연구', body: 'DHT를 만드는 5α-환원효소 관련 억제 지표가 보고되었습니다. 동시에 모유두 세포의 KGF(모발 성장인자) 발현 증가. 모발 관련 경로 관리 지표(Marine Drugs 2020).' },
        ...
        { icon: '', color: '#0A9BAD', title: 'DNA 광손상 58% 차단 — 나이 들수록 약해지는 UV 방어 보강', body: '나이 들수록 피부 DNA 수복 능력이 저하됩니다. 플로로탄닌이 세포 내부에서 UVB 광손상을 58% 억제. 세포 수복 능력을 보완합니다(Antioxidants 2024).' },
        { icon: '', color: '#10B981', title: '항염증·항산화 — 호르몬 변화로 악화되는 피부 염증 안정화', body: '폐경 전후 피부 민감성·발진·트러블 증가는 염증 증가 때문. NF-κB 차단으로 피부 염증 안정. 항산화 연구 지표로 산화 노화 속도를 낮춥니다.' },
      ],
      ...
      compare: [
        { left: '호르몬 치료(HRT) → 효과적이나 암·혈전 위험', right: '플로로탄닌 → DHT+MMP+멜라닌 기전 차단, 개인별 주의 필요' },
        { left: '콜라겐·히알루론산 → 보충만, 분해 가속 계속', right: '플로로탄닌 → MMP 억제로 분해 속도 자체를 낮춤' },
        { left: '탈모 샴푸 → 두피 외부만, 5α-환원효소 차단 없음', right: '플로로탄닌 → 내부에서 DHT 생성 경로 조절 가능성' },
    ...
    cancer_2: {
      urgency: '암 치료 중 면역이 무너지면 치료 중 지표도 무너집니다',
      ...
      points: [
        { icon: '', color: '#10B981', title: 'NK세포 활성 유지 — 항암 치료 중 면역 감시 유지', body: '자연살해세포(NK Cell) 활성화로 비정상 세포 감시 능력 유지. 항암 치료로 저하된 NK세포 기능 보완. 치료 중 지표와 면역 기능을 동시에 지킵니다.' },
        { icon: '', color: '#0A9BAD', title: 'Nrf2 경로 — 정상세포 방어막 최대화', body: '세포 마스터 항산화 Nrf2를 활성화해 항암제·방사선으로부터 정상 세포를 보호. 해독 효소(HO-1, NQO1) 유도로 치료 중 산화 스트레스 관련 보조 연구 지표.' },
        { icon: '', color: '#7C3AED', title: '암세포주 모델의 아포토시스 지표 — 정상세포 보호 관련 전임상 지표', body: '췌장암·유방암·대장암·간암 세포에서 선택적 아포토시스 유도. Bax/Bcl-2 비율 조절. 정상 세포 독성은 제한적이었다는 세포주 연구가 있습니다(Antioxidants 2023).' },
        { icon: '', color: '#EC4899', title: 'VEGF 억제 — 종양 혈관신생 차단 보조', body: '종양이 자체 혈관을 만들어 영양을 공급받는 혈관신생을 억제. 기존 항암 치료의 VEGF 억제 기전을 천연 성분으로 보완.' },
        { icon: '', color: '#B8953A', title: '항산화 연구 지표 — 활성산소로 인한 DNA 손상 차단', body: '항암 치료 중 급증하는 활성산소를 비타민C 대비 10~15배 강한 항산화력으로 소거. DNA 돌연변이 → 2차 암화 위험을 낮춥니다.' },
      ],
      refs: ['Park SY et al. Antioxidants 2023', 'Sugiura Y et al. Antioxidants 2020', 'Wijesinghe et al. Marine Drugs 2021'],
      systemMsg: '항암 치료 중 지표 = 암세포 제거 × 면역 유지\n플로로탄닌은 면역을 지키며 항암 보조 역할을 합니다.',
      ...
      compare: [
        ...
        { left: '후코이단 → 면역 지지, 암세포주 지표 약함', right: '플로로탄닌 → 정상세포 보호 관련 전임상 지표+암세포주 지표' },
    ...
    gut_2: {
      ...
      intro: '장과 뇌는 미주신경·장내 미생물·면역·호르몬으로 연결된 하나의 축입니다. 장내 미생물이 무너지면 세로토닌이 부족해지고, 장 독소가 혈뇌장벽을 뚫고 뇌 염증을 일으킵니다. 우울·불안·집중력 저하의 숨겨진 원인이 장에 있을 수 있습니다. 플로로탄닌은 장-뇌 축 관련 지표를 함께 정리합니다.',
      timeline: [
      ...
      points: [
        ...
        { icon: '', color: '#0A9BAD', title: '장 투과성 42% 감소 — 장 LPS 관련 뇌 염증 경로 연구', body: '장 점막 장벽 강화로 장 LPS와 뇌 염증 경로의 연관성을 설명합니다. 뇌 염증 억제. 장-뇌 축 염증 연쇄를 끊습니다.' },
        { icon: '', color: '#10B981', title: '혈중 LPS 35% 감소 — 뇌 염증 관련 LPS 지표 연구', body: '장에서 유입되는 세균 내독소 LPS 35% 감소. LPS는 뇌에서 신경 염증을 일으켜 우울·인지 저하·피로를 유발합니다. 관련 지표를 함께 보는 것이 핵심입니다.' },
        ...
        { icon: '', color: '#E05050', title: '장·뇌 염증 동시 억제 — NF-κB·NLRP3 이중 차단', body: '장 염증(IBS·과민성 장) + 뇌 염증(우울·인지 저하)의 공통 경로 NF-κB·NLRP3를 동시에 억제. 장-뇌 축 염증을 기전 수준에서 끊습니다.' },
      ],
    ...
    sexual_male: {
      ...
      intro: '남성 성기능은 결국 혈관 기능입니다. 해면체에 혈류가 충분히 공급되어야 하고, 그 신호는 산화질소(NO)가 담당합니다. 동시에 테스토스테론이 줄어들면 활력·근력·성욕이 함께 하락합니다. 플로로탄닌은 eNOS, 테스토스테론 생산 환경, 전립선 염증 관련 전임상 지표를 함께 설명하는 소재입니다.',
      timeline: [
      ...
      points: [
        ...
        { icon: '', color: '#B45309', title: '테스토스테론 보호 — 산화 손상으로부터 라이디히 세포를 지키다', body: '고환의 라이디히 세포는 테스토스테론을 생산하지만 산화 스트레스에 취약합니다. 플로로탄닌의 항산화 지표와 라이디히 세포 보호 가능성이 전임상에서 다뤄집니다.' },
        { icon: '', color: '#059669', title: '전립선 염증 차단 — NF-κB·NLRP3로 전립선비대·전립선염 관리', body: '전립선 비대·만성 전립선염의 핵심 경로 NF-κB·NLRP3를 이중 차단. 전립선 부종·염증 완화로 배뇨 불편·성기능 저하를 동시에 개선합니다.' },
    ...
    sexual_female: {
      ...
      points: [
        ...
        { icon: '', color: '#7C3AED', title: 'GABA-A 수용체 활성 — 갱년기 불면의 뿌리를 끊다', body: '갱년기 불면은 에스트로겐 감소 → GABA 수용체 민감도 저하 때문입니다. 플로로탄닌과 GABA-A 수용체 관련 지표가 보고되었습니다. 수면 문제는 수면 위생·진료 상담과 함께 봐야 합니다. 수면제 등 의약품을 대체하지 않는 범위에서 수면 관리를 돕는 정보로 해석해야 합니다.' },
      ...
      compare: [
        { left: '호르몬 치료(HRT) → 효과적이나 유방암·혈전 위험', right: '플로로탄닌 → eNOS+GABA+항염+피부 기전, 개인별 주의 필요' },
      ...
      targets: ['폐경 전후 열감·발한·불면이 심한 분', '갱년기 감정 기복·우울감이 걱정되는 분', '성욕 저하·건조감이 생긴 40~60대 여성', '호르몬 치료 복용 전 주의점을 확인하려는 분', '갱년기와 함께 피부 노화·탈모가 빨라진 분', '갱년기 증상을 진료와 함께 생활 정보를 정리하려는 분'],
      ctaMsg: '지금 전화하시면\n여성 갱년기 타입별 1:1 맞춤 상담을 드립니다',
    },

    /* ────── CANCER_ALL : 모든 암 통합 — 암은 하나의 몸에서 온다 ────── */
    cancer_all: {
      urgency: '암 관련 연구 축은 종류가 달라도 산화·염증·면역·혈관신생을 함께 봅니다',
      headline: ['암 관련 공통 연구 축을 봅니다', '산화·염증·면역저하·혈관신생', '이 4가지가 모든 암의 공통 경로입니다'],
      accentLine: '암 종류는 달라도 발생 기전은 하나 — 공통 경로를 정리하면 모든 암에 적용됩니다',
      intro: '폐암·간암·대장암·유방암·췌장암·전립선암. 이름은 다르지만 몸 안에서 일어나는 일은 같습니다. 활성산소가 DNA를 손상시키고, 만성 염증이 암 미세환경을 만들고, 면역이 지쳐 이상 세포를 놓치고, 종양이 혈관을 만들어 자라납니다. 플로로탄닌은 암 종류와 무관하게 반복해서 다뤄지는 산화·염증·면역·혈관신생 연구 축을 정리합니다.',
      timeline: [
        { week: '관리 1~2주', body: '항산화 지표와 DNA 산화 손상 관련 연구를 참고합니다. 피로·염증은 증상 기록과 진료 상담이 우선입니다.' },
      ...
      points: [
        { icon: '', color: '#7C2D12', title: '연구 축 ① 산화 — DNA 손상 관련 지표', body: '활성산소가 DNA를 공격해 돌연변이를 만드는 것이 세포 손상 관련 초기 단계. DPPH IC₅₀ 0.06 mg/mL, 비타민C 대비 항산화 지표가 보고되었지만, DNA 산화 손상 관리는 실험 조건 안에서 해석해야 합니다.' },
        { icon: '', color: '#B45309', title: '연구 축 ② 염증 — 암 미세환경 관련 지표', body: '만성 저등급 염증은 암세포가 생존·증식하는 환경을 만듭니다. NF-κB·NLRP3 이중 차단으로 TNF-α 68%·IL-6 54%·IL-1β 74% 억제. 암 미세환경 관련 염증 지표를 연구합니다. 폐·간·장·유방 어느 부위든 동일하게 작용.' },
        { icon: '', color: '#065F46', title: '연구 축 ③ 면역저하 — 면역 감시 관련 지표', body: 'NK세포 활성 향상으로 하루 수천 개 생기는 이상 세포 감시와 관련된 면역 지표를 관찰. Nrf2 활성화로 세포 자체 방어막 최대화. 면역 감시망이 촘촘해지면 암 종류와 무관하게 면역 감시 지표를 해석하는 데 참고됩니다.' },
        { icon: '', color: '#1E3A5F', title: '연구 축 ④ 혈관신생 — 종양 혈관신생 관련 연구 지표', body: '종양은 VEGF를 분비해 자체 혈관을 만들고 영양을 공급받아 자랍니다. 플로로탄닌의 VEGF 억제로 이 혈관신생을 차단. 폐암·간암·유방암·대장암 모두 동일한 혈관신생 기전을 사용합니다.' },
        { icon: '', color: '#6B21A8', title: '결과 — 암세포만 선택적 아포토시스, 정상세포 보호 관련 전임상 지표', body: '췌장암·유방암·대장암·간암 세포에서 Bax/Bcl-2 비율 조절로 미토콘드리아 경로 아포토시스 유도. 정상 세포 독성은 제한적이었다는 세포주 연구가 있습니다(Antioxidants 2023). 암 종류가 달라도 아포토시스 경로는 공통입니다.' },
      ],
      refs: ['Park SY et al. Antioxidants 2023', 'Wijesinghe et al. Marine Drugs 2021', 'Sugiura Y et al. Antioxidants 2020'],
      systemMsg: '산화 → 염증 → 면역저하 → 혈관신생\n이 4가지가 모든 암의 공통 연구 축입니다. 공통 경로를 정리하면 어떤 암에도 적용됩니다.',
      p2headline: '암 관련 관리는 의료진 계획이 우선이며 공통 연구 축을 함께 봅니다',
      compare: [
        { left: '암 종류별 표준치료 → 적응증에 맞춘 의료진 계획', right: '플로로탄닌 → 산화·염증·면역·혈관 4가지 연구 축' },
        { left: '비타민C 고용량 → 산화만, 염증·면역·혈관신생 없음', right: '플로로탄닌 → 4대 암 관련 공통 연구 축' },
      ...
      targets: ['암 가족력이 있어 세포 보호 정보를 찾는 분', '암 진단 후 생활·영양 환경을 정리하려는 분', '항암 치료와 병행해 기전 수준에서 관리하고 싶은 분', '만성 염증·면역 저하로 암 위험이 높다고 느끼는 분', '특정 암이 아닌 전반적 세포 보호가 목표인 분', '가족 중 암 환자가 있어 생활·영양 정보를 정리하려는 분'],
      ctaMsg: '지금 전화하시면\n세포 보호 정보 1:1 맞춤 상담을 드립니다',
    },
    ...
    cancer_combo_1: {
      ...
      intro: '하루에도 수천 개의 이상 세포가 생겨납니다. 건강한 면역 시스템은 이것을 즉시 제거합니다. 문제는 만성 염증·산화 스트레스·면역 저하가 동시에 누적될 때입니다. 플로로탄닌은 ①활성산소 관련 경로 조절 ②Nrf2 세포 방어막 최대화 ③NK세포 감시 강화 ④암세포주 모델의 아포토시스 지표 4중 기전으로 세포 보호·면역 관련 연구를 교육용으로 정리합니다.',
      timeline: [
        { week: '관리 1~2주', body: '항산화 지표와 DNA 산화 손상 관련 연구를 참고합니다. 피로·염증은 증상 기록과 진료 상담이 우선입니다.' },
      ...
      points: [
        { icon: '', color: '#10B981', title: 'DPPH IC₅₀ 0.06 mg/mL — 비타민C 대비 항산화 연구 지표', body: '활성산소, DNA 돌연변이, 암화 연쇄와 관련된 항산화 지표가 보고되었습니다. 비교 수치는 실험 조건 안에서 해석해야 합니다.' },
        { icon: '', color: '#0A9BAD', title: 'Nrf2 마스터 스위치 — 세포 방어막을 최대로 끌어올리다', body: '세포 내 마스터 항산화 전사인자 Nrf2를 직접 활성화. HO-1·NQO1·GST 해독 효소 군을 유도. 세포가 스스로 발암물질을 해독하고 DNA 손상을 수복하는 능력을 최대화합니다.' },
        { icon: '', color: '#7C3AED', title: 'NK세포 활성 강화 — 면역 감시망을 촘촘하게', body: '자연살해세포(NK Cell)의 활성을 높여 이상 세포 발견·제거 능력 강화. 하루 수천 개 생기는 이상 세포를 면역이 놓치지 않도록 감시망을 복원합니다.' },
        { icon: '', color: '#EC4899', title: '암세포주 모델의 아포토시스 지표 — 정상세포는 완전 보호', body: '췌장암·유방암·대장암·간암 세포에서만 미토콘드리아 경로 아포토시스 유도. Bax/Bcl-2 비율 조절로 이상 세포만 선택적 제거. 정상 세포 독성은 제한적이었다는 세포주 연구가 있습니다(Antioxidants 2023).' },
        { icon: '', color: '#F97316', title: 'NF-κB·NLRP3 이중 차단 — 암을 키우는 만성 염증 제거', body: '만성 저등급 염증은 암의 미세환경을 만듭니다. NF-κB p65 핵 이전 억제 가능성 보고 + NLRP3 억제로 종양 촉진 염증 환경 자체를 해소합니다. TNF-α 68%, IL-6 54%, IL-1β 74% 억제.' },
      ],
      refs: ['Park SY et al. Antioxidants 2023', 'Sugiura Y et al. Antioxidants 2020', 'Wijesinghe et al. Marine Drugs 2021'],
      systemMsg: '활성산소 → DNA 손상 → 면역 저하 → 암화\n이 연쇄를 4중 기전으로 동시에 차단합니다.',
      p2headline: '암 예방, 단일 항산화제 하나로는 불가능합니다',
      compare: [
        { left: '비타민C → 단독 항산화, Nrf2·NK세포 작용 없음', right: '플로로탄닌 → 항산화 연구 지표 + Nrf2 + NK세포 동시' },
        { left: '셀레늄 → 항산화 보조, 선택적 아포토시스 없음', right: '플로로탄닌 → DNA 보호 + 암세포주 선택성 지표 제거까지' },
        { left: '후코이단 → 면역 지지, 암세포주 지표 약함', right: '플로로탄닌 → 정상세포 보호 관련 전임상 지표 + 이상세포만 제거' },
    ...
    cancer_combo_2: {
      ...
      intro: '항암 화학요법과 방사선은 암세포와 함께 정상 세포, 특히 면역세포를 공격합니다. 면역이 무너지면 폐렴·패혈증 위험이 급증하고 치료를 중단해야 할 수 있습니다. 플로로탄닌은 항암 치료 중에도 ①정상세포 보호(Nrf2), NK세포 기능, 아포토시스 지표, 항산화 연구를 함께 설명합니다. 항암 치료 중에는 의료진 상담이 우선입니다.',
      timeline: [
      ...
      points: [
        { icon: '', color: '#10B981', title: 'Nrf2 경로 — 항암제·방사선으로부터 정상세포를 지키다', body: 'Nrf2 활성화 → HO-1·NQO1·GST 해독 효소 유도 → 항암제 독성으로부터 정상 세포 보호. 간·신장·골수세포 손상을 줄여 치료를 끝까지 유지할 수 있도록 돕습니다.' },
        { icon: '', color: '#0A9BAD', title: 'NK세포 활성 유지 — 치료 중 면역 감시망 유지', body: '항암 치료로 저하된 NK세포 기능을 보완·유지. 자연살해세포가 이상 세포를 감시·제거하는 능력을 유지해 치료 중 지표와 면역 방어를 동시에 지킵니다.' },
        { icon: '', color: '#7C3AED', title: '암세포주 모델의 아포토시스 지표 — 항암 보조 연구 지표', body: 'Bax/Bcl-2 비율 조절로 암세포에서만 아포토시스 유도. 항암제의 종양 세포 사멸 효과를 천연 성분으로 보조. 정상세포 보호 지표도 함께 보고(Antioxidants 2023).' },
        ...
        { icon: '', color: '#B8953A', title: '항산화 연구 지표 — 치료 중 급증하는 활성산소 소거', body: '항암 치료 과정에서 급증하는 활성산소를 비타민C 대비 10~15배 강한 항산화력으로 소거. DNA 2차 손상·정상세포 산화 손상을 방지하고 치료 독성 부작용을 완화합니다.' },
      ],
      refs: ['Park SY et al. Antioxidants 2023', 'Sugiura Y et al. Antioxidants 2020', 'Wijesinghe et al. Marine Drugs 2021'],
      systemMsg: '항암 치료 중 지표 = 암세포 사멸 × 면역 유지\n플로로탄닌은 치료 중 지표를 단정하지 않으며 정상세포 보호 관련 연구 지표를 정리합니다.',
      ...
      compare: [
        ...
        { left: '후코이단 → 면역 지지, 암세포주 지표 약함', right: '플로로탄닌 → 정상세포 완전보호 + 암세포주 지표' },
        { left: '항산화 복합제 → 일반 항산화, Nrf2 직접 활성 없음', right: '플로로탄닌 → Nrf2 마스터 스위치 직접 ON' },
      ],
      targets: ['항암 치료(화학·방사선) 중인 분', '항암 치료 후 영양·면역 회복 정보를 찾는 분', '항암 중 피로·식사·면역저하 기록을 정리하려는 분', '암 수술 후 회복 중인 분', '항암 치료 중 영양·면역 기록을 정리하고 싶은 분', '가족의 항암 치료를 돕고 싶은 분'],
    ...
    recovery_1: {
      ...
      intro: '혈당·혈관·뇌·면역·장·피부는 분리된 기관이 아닙니다. 혈당이 올라가면 혈관이 손상되고, 혈관이 손상되면 뇌로 가는 혈류가 줄고, 장이 무너지면 염증이 전신으로 퍼집니다. 하나가 무너지면 전체가 흔들립니다. 플로로탄닌은 6개의 시스템 연결고리를 연구 관점에서 함께 설명하는 소재입니다.',
      timeline: [
      ...
      points: [
        ...
        { icon: '', color: '#7C3AED', title: '뇌 → 수면 연결 회복 — 밤에 청소해야 낮에 작동한다', body: 'BACE1 억제로 뇌 노폐물 생성 차단 + GABA-A 활성으로 수면 질 회복 → 글림파틱 청소 시간 확보 → 아침에 개운한 뇌. 수면이 회복되면 인지력·면역·호르몬이 함께 회복됩니다.' },
        ...
        { icon: '', color: '#EC4899', title: '피부 → 노화 연결 회복 — 안에서부터 젊어지다', body: 'MMP-1 68% 억제로 콜라겐 분해 차단 + 항산화 연구 지표로 세포 산화 노화 방지 + 티로시나제 억제로 미백. 피부는 전신 회복의 거울입니다. 몸이 회복되면 피부가 먼저 반응합니다.' },
      ],
      ...
      compare: [
        { left: '혈당약+혈압약·수면제 등 각각 → 연결 회복 없음', right: '플로로탄닌 → 6개 시스템 연결 동시 회복' },
        { left: '종합영양제 → 결핍 보충, 기전 연결 없음', right: '플로로탄닌 → 분자 기전으로 시스템 연결 복원' },
        { left: '유산균+콜라겐+오메가3 → 각각 단독 효과', right: '플로로탄닌 → 장-피부-혈관-뇌 동시 연결 회복' },
        { left: '단순 항산화제 → 산화만, 회복 기전 없음', right: '플로로탄닌 → 세포 회복 관련 전임상 지표' },
      ],
      targets: ['여러 성분을 따로 먹지만 몸이 나아지지 않는 분', '40대 이후 전신 회복력이 떨어진 분', '만성 피로·전신 무기력이 수년째 지속되는 분', '혈당·혈압·수면 등 여러 문제가 동시에 있는 분', '전신 컨디션 기록을 체계적으로 정리하고 싶은 분', '근본부터 몸을 바꾸고 싶은 50~70대'],
      ctaMsg: '지금 전화하시면\n전신 회복 타입별 1:1 맞춤 상담을 드립니다',
    },

    /* ────── RECOVERY_2 : 노화 관리·세포 재생 — 세포부터 젊어진다 ────── */
    recovery_2: {
      ...
      intro: '우리 몸의 37조 개 세포는 매일 스스로를 수복합니다. 그런데 산화 스트레스가 누적되고, 미토콘드리아가 지치고, 세포 자체 방어막이 무너지면 수복이 실패합니다. 그 결과가 노화입니다. 플로로탄닌은 세포 방어·회복 관련 전임상 지표를 분자 수준에서 설명하는 소재입니다.',
      timeline: [
        ...
        { week: '관리 2~3개월', body: '전신 세포 레벨 회복 누적. 피부 나이·혈관 나이·뇌 기능 동반 향상. 주관적 컨디션 변화를 기록해 볼 수 있습니다.' },
      ],
      points: [
        { icon: '', color: '#B8953A', title: '항산화 연구 지표 — 37조 세포의 산화 누적을 되돌리다', body: 'DPPH IC₅₀ 0.06 mg/mL 등 항산화 지표가 보고되었습니다. 세포 산화 손상과 노화 관련 연구로 해석해야 합니다.' },
        { icon: '', color: '#10B981', title: 'Nrf2 → 미토콘드리아 복원 — 세포 에너지의 발전소를 고치다', body: 'Nrf2 활성화 → 미토콘드리아 생합성 촉진 → 세포 ATP 생산 효율 회복. 미토콘드리아가 살아나면 피로·세포 수복 관련 지표를 함께 보는 연구입니다. 노화의 핵심 기전 복원.' },
        { icon: '', color: '#7C3AED', title: '세포 자가포식(Autophagy) 지원 — 세포가 스스로 청소한다', body: '손상된 세포 내 소기관을 분해·재활용하는 자가포식 과정을 지원. 세포 내 쓰레기 제거 → 새로운 세포 구성요소 합성 → 세포 건강 관련 지표 관리. 노화 세포의 자기 청소 능력 복원.' },
        { icon: '', color: '#E05050', title: '만성 염증 소거 — 노화를 가속하는 Inflammaging 차단', body: '"Inflammaging(염증 노화)" — 만성 저등급 염증이 노화 관련 염증 지표로 자주 언급됩니다. NF-κB·NLRP3 이중 차단으로 인플라메이징을 차단. 염증이 꺼지면 노화 관련 지표를 함께 관찰합니다.' },
        { icon: '', color: '#06B6D4', title: '장-전신 회복 축 — 장이 회복되면 전신이 젊어진다', body: 'Akkermansia 3.2배 증식 → 장벽 강화 → LPS 감소 → 전신 대사성 염증 해소 → 혈당·혈관·뇌·피부 연쇄 회복. 장 마이크로바이옴은 노화 연구에서 중요한 축입니다.' },
      ],
      refs: ['Wijesinghe et al. Marine Drugs 2021', 'Park SY et al. Antioxidants 2023', 'Jung HA et al. Nutrients 2024'],
      systemMsg: '세포가 스스로 회복하면 전신 건강 지표를 함께 볼 수 있습니다.\n플로로탄닌은 세포 회복 관련 연구 지표를 정리합니다.',
      p2headline: '안티에이징, 바르고 먹는 것으로는 한계가 있습니다',
      compare: [
        { left: 'NMN·NAD+ → 미토콘드리아 보조, 다중 기전 없음', right: '플로로탄닌 → Nrf2로 미토콘드리아+세포방어 동시 복원' },
        { left: '레스베라트롤 → 단일 항산화, 흡수율 불안정', right: '플로로탄닌 → 항산화 연구 지표 + Nrf2 + 자가포식 지원' },
        { left: '콜라겐·히알루론산 → 외부 보충, 세포 회복 없음', right: '플로로탄닌 → 세포 스스로 콜라겐 분해 막고 합성 촉진' },
        { left: '항노화 종합제 → 성분 나열, 시너지 없음', right: '플로로탄닌 → 단일 분자로 노화 관련 여러 경로 연구' },
      ],
      targets: ['나이보다 빨리 늙는다는 느낌을 받는 분', '만성 피로가 수년째 해결되지 않는 분', 'NMN·NAD+·레스베라트롤에 관심 있는 분', '세포 수준 안티에이징을 원하는 40~70대', '전신 노화 속도를 늦추고 싶은 분', '전신 컨디션 기록을 체계적으로 정리하고 싶은 분'],
      ctaMsg: '지금 전화하시면\n노화 관리 타입별 1:1 맞춤 상담을 드립니다',
    },
  ...
  return (
    <div id={`pdf-p1-${id}`} style={{
      ...
      <div style={{ background: `${mat.color}15`, border: `1.5px solid ${mat.color}50`, borderRadius: 8, padding: '7px 14px', marginBottom: 12 }}>
        <p style={{ fontSize: 14, fontWeight: 800, color: mat.color, margin: 0 }}> {c.urgency}</p>
      </div>
...
function PdfPage2({ mat, name, tel, url, id, qrDataUrl }) {
  ...
  return (
    <div id={`pdf-p2-${id}`} style={{
      ...
      {/* 추천 대상 */}
      <div style={{ marginBottom: 14 }}>
        <p style={{ fontSize: 14, fontWeight: 900, color: NAVY, margin: '0 0 8px' }}> 이런 분들께 이런 분께 참고 자료가 됩니다</p>
      ...
      <div style={{ padding: '8px 14px', background: '#f8f8f8', borderRadius: 8, border: '1px solid #e0e0e0', marginBottom: 16 }}>
        <p style={{ fontSize: 11, color: '#999', lineHeight: 1.6, margin: 0 }}>
           본 자료는 플로로탄닌 관련 연구 정보를 정리한 교육용 자료입니다. 특정 제품의 효능·효과를 보증하거나 질병의 예방·치료를 목적으로 하지 않습니다. 질환이 있거나 약물 복용 중인 경우 전문가 상담 후 판단하시기 바랍니다.
        </p>
      </div>
  ...
  return (
    <div style={{ width:794, minHeight:1123, background:'#fff', padding:'28px 44px', boxSizing:'border-box', fontFamily:"'Noto Sans KR','Apple SD Gothic Neo',sans-serif", color:'#1e1e1e' }}>
      ...
      <div style={{ border:`3px solid ${col}`, borderRadius:16, padding:'16px 22px', display:'flex', alignItems:'center', gap:20, marginTop:8 }}>
        <div style={{ flex:1 }}>
          <div style={{ display:'inline-block', background:col, color:'#fff', fontSize:11, fontWeight:900, padding:'3px 12px', borderRadius:4, marginBottom:8 }}> 건강정보 상담</div>
...
async function drawProductPage1(scale = 2) {
  ...
  // ── 헤드라인
  ctx.font = 'bold 42px sans-serif'; ctx.fillStyle = NAVY; ctx.textBaseline = 'top'
  ctx.fillText('건강식품,', pad, y); y += 54
  ctx.font = 'bold 30px sans-serif'; ctx.fillStyle = col
  ...
  const introLinesRaw = wrapText(ctx, introTxt, body - 36)
  const introLines = introLinesRaw.slice(0, 3)
  if (introLinesRaw.length > 3 && introLines.length > 0) {
    introLines[introLines.length - 1] = `${introLines[introLines.length - 1].slice(0, Math.max(0, introLines[introLines.length - 1].length - 1))}...`
  }
  const introLH = 22
  const introH = introLines.length * introLH + 16
  ...
  introLines.forEach((l, i) => ctx.fillText(l, pad + 16, y + 8 + i * introLH))
  y += introH + 10

  // ── 섹션1: 이름 vs 구조
  ctx.fillStyle = col; ctx.fillRect(pad, y, 5, 26)
  ctx.font = 'bold 16px sans-serif'; ctx.fillStyle = NAVY; ctx.textBaseline = 'middle'
  ...
  const cBoxH = 14 + 24 + badItems.length * 18 + 8  // 헤더 + 간격 + 항목들 + 하단 여백
  ...
  ctx.font = '13px sans-serif'; ctx.fillStyle = '#A02828'
  badItems.forEach((t, i) => ctx.fillText(t, pad + 14, y + 34 + i * 18))
  ...
  ctx.font = '13px sans-serif'; ctx.fillStyle = '#146E46'
  goodItems.forEach((t, i) => ctx.fillText(t, pad + cW + 24, y + 34 + i * 18))
  y += cBoxH + 10
  ...
  const mW = Math.floor((body - 20) / 3), mH = 98
  mols.forEach(([f, n, s, d, c], i) => {
    ...
    ctx.font = 'bold 30px sans-serif'; ctx.fillStyle = c; ctx.textBaseline = 'top'
    ctx.fillText(f, mx + 12, y + 8)
    ctx.font = 'bold 13px sans-serif'; ctx.fillStyle = NAVY; ctx.fillText(n, mx + 12, y + 48)
    ctx.font = '12px sans-serif'; ctx.fillStyle = '#888'
    ctx.fillText(s, mx + 12, y + 68); ctx.fillText(d, mx + 12, y + 83)
  })
  y += mH + 10
  ...
  const seaLinesRaw = wrapText(ctx, seaTxt, body - 36)
  const seaLines = seaLinesRaw.slice(0, 3)
  if (seaLinesRaw.length > 3 && seaLines.length > 0) {
    seaLines[seaLines.length - 1] = `${seaLines[seaLines.length - 1].slice(0, Math.max(0, seaLines[seaLines.length - 1].length - 1))}...`
  }
  const seaLH = 20
  const seaH = seaLines.length * seaLH + 12
  roundRect(ctx, pad + 5, y, body - 5, seaH, 8); ctx.fillStyle = '#f8f9fc'; ctx.fill()
  ctx.fillStyle = col; ctx.fillRect(pad, y, 5, seaH)
  ctx.fillStyle = '#333'; ctx.textBaseline = 'top'
  seaLines.forEach((l, i) => ctx.fillText(l, pad + 16, y + 6 + i * seaLH))
  y += seaH + 8
  ...
  tools.forEach(t => {
    ...
    ctx.font = 'bold 14px sans-serif'
    roundRect(ctx, pad + 14, y + Math.floor((tH - 22) / 2), lw, 22, 6); ctx.fillStyle = t.tc; ctx.fill()
    ctx.fillStyle = '#fff'; ctx.textBaseline = 'middle'
    ctx.fillText(t.label, pad + 24, y + tH / 2)
    ctx.font = '12px sans-serif'; ctx.fillStyle = '#555'; ctx.textBaseline = 'top'
    const topPad = Math.floor((tH - mechLines.length * 14) / 2)
    mechLines.forEach((l, i) => ctx.fillText(l, pad + lw + 20, y + topPad + i * 14))
    y += tH + 4
  })
  y += 8
...
async function drawProductPage2(partnerName, partnerTel, qrImg, scale = 2) {
  ...
  products.forEach(p => {
    ...
    const descLines = descLinesRaw.slice(0, 2)
    if (descLinesRaw.length > 2 && descLines.length > 0) {
    ...
    const usageLines = usageLinesRaw.slice(0, 1)
    if (usageLinesRaw.length > 1 && usageLines.length > 0) {
    ...
    ctx.font = 'bold 18px sans-serif'; ctx.fillStyle = p.pc
    ctx.textAlign = 'right'; ctx.textBaseline = 'top'
    ctx.fillText(p.price, W - pad - 10, y + 16)
    ctx.textAlign = 'left'
    ...
    ctx.font = 'bold 13px sans-serif'; ctx.fillStyle = p.pc
    ctx.textBaseline = 'top'; ctx.textAlign = 'center'
    ctx.fillText(p.slogan, W / 2, cy); ctx.textAlign = 'left'; cy += 20

    // ── 설명
    ctx.font = '13px sans-serif'; ctx.fillStyle = '#333'; ctx.textBaseline = 'top'
    descLines.forEach(l => { ctx.fillText(l, pad + 16, cy); cy += 18 }); cy += 6
    ...
    tagRows.forEach((row, rowIdx) => {
      ...
      if (rowIdx < tagRows.length - 1) cy += 28
    })
    cy += 24 + 6

    // ── 섭취방법
    ctx.fillStyle = '#e0e4ec'; ctx.fillRect(pad + 16, cy, body - 24, 1); cy += 8
    ctx.font = 'bold 12px sans-serif'; ctx.fillStyle = NAVY; ctx.textBaseline = 'top'
    ctx.fillText('섭취 방법', pad + 16, cy); cy += 20
    ctx.font = '12px sans-serif'; ctx.fillStyle = '#666'
    usageLines.forEach(l => { ctx.fillText(l, pad + 16, cy); cy += 16 }); cy += 6

    // ── 하단 배지
    const badgeTxt = 'SEANOL C.A.F.  감태추출물 플로로탄닌 해양 폴리페놀  ·  국산'
    roundRect(ctx, pad + 5, cy, body - 5, 24, 6)
    ctx.fillStyle = hexAlpha(p.pc, 0x14); ctx.fill()
    ctx.font = '11px sans-serif'; ctx.fillStyle = p.pc
    ctx.textBaseline = 'middle'; ctx.textAlign = 'center'
    ctx.fillText(badgeTxt, W / 2, cy + 12); ctx.textAlign = 'left'
...
async function drawPage1(mat, scale = 2) {
  ...
  const urgencyLines = wrapText(ctx, `  ${c.urgency}`, body - 32)
...
async function drawPage2(mat, partnerName, partnerTel, qrImg, scale = 2) {
  ...
  ctx.font = 'bold 17px sans-serif'; ctx.fillStyle = NAVY; ctx.textBaseline = 'top'
  ctx.fillText('  이런 분들께 이런 분께 참고 자료가 됩니다', pad, y); y += 24
  ...
  // ── 면책 박스
  const disclaimerText = ' 본 자료는 플로로탄닌 관련 연구 정보를 정리한 교육용 자료입니다. 특정 제품의 효능·효과를 보증하거나 질병의 예방·치료를 목적으로 하지 않습니다. 질환이 있거나 약물 복용 중인 경우 전문가 상담 후 판단하시기 바랍니다.'
  ctx.font = '13px sans-serif'
