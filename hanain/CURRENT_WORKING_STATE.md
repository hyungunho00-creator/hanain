...
Last verified: 2026-06-02 14:59 KST

Production domain:

- `https://phlorotannin.com`
- `https://www.phlorotannin.com` redirects to apex
- Current verified deployment: `https://hanain-h5rx2bia3-01056528206s-projects.vercel.app`
...
- Supabase `public.posts`: canonical published blog posts (`563` published current posts).
...
- `https://phlorotannin.com/sitemap.xml`
  ...
  - Q&A detail URLs: `1814`
  - Q&A tag URLs: `220`
  - blog detail URLs: `563`
  - insight detail URLs: `163`
