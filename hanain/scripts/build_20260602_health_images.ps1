...
$items = @(
  @{
    Source = 'heatwave-sleep-fatigue-hydration-gamtae-2026.png'
    Output = 'heat-health-action-plan-hydration-blood-pressure-2026.png'
    Title = '폭염 건강관리'
    Subtitle = '수분 · 혈압 · 복용약 기록'
    Chips = @('폭염', '혈압', '수분')
  },
  @{
    Source = 'glp1-muscle-loss-protein-resistance-training-2026.png'
    Output = 'glp1-plateau-muscle-protein-fiber-record-2026.png'
    Title = 'GLP-1 시대의'
    Subtitle = '근육 · 단백질 · 식이섬유 관리'
    Chips = @('GLP-1', '근육', '단백질')
  },
  @{
    Source = 'ultra-processed-food-blood-sugar-inflammation-guide-2026.png'
    Output = 'ultra-processed-food-heart-risk-blood-sugar-label-2026.png'
    Title = '초가공식품'
    Subtitle = '혈당 · 심혈관 위험 라벨 읽기'
    Chips = @('초가공', '혈당', '라벨')
  }
)
...
foreach ($item in $items) {
  ...
  Draw-RoundedRect $g (New-Brush 252 255 255 255) 72 66 680 500 28
