...
$items = @(
  @{
    Source = 'glp1-hair-loss-telogen-effluvium-protein-ferritin-2026.png'
    Output = 'oral-minoxidil-hair-loss-blood-pressure-safety-record-2026.png'
    Title = '먹는 미녹시딜 확인'
    Subtitle = '탈모 · 혈압 · 부종 기록'
    Chips = @('탈모', '혈압', '사진')
  },
  @{
    Source = 'wildfire-smoke-pm25-respiratory-antioxidant-2026.png'
    Output = 'cleaner-indoor-air-respiratory-virus-ventilation-record-2026.png'
    Title = '실내 공기질 기록'
    Subtitle = '환기 · HEPA · 호흡기 바이러스'
    Chips = @('환기', 'HEPA', '호흡기')
  },
  @{
    Source = 'measles-mmr-vitamin-a-outbreak-check-2026.png'
    Output = 'h5n1-bird-flu-raw-milk-exposure-monitoring-record-2026.png'
    Title = 'H5N1 노출 확인'
    Subtitle = '조류독감 · 생우유 · 증상 기록'
    Chips = @('H5N1', '생우유', '10일')
  }
)
