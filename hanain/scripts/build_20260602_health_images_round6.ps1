...
$items = @(
  @{
    ...
    Output = 'wearable-vo2max-cardio-fitness-longevity-record-2026.png'
    Title = 'VO2 max 기록'
    Subtitle = '심폐체력 · 웨어러블 · 건강노화'
    Chips = @('VO2 max', '심폐체력', '운동')
  },
  @{
    Source = 'sleep-regularity-circadian-heart-risk-record-2026.png'
    Output = 'energy-drink-preworkout-caffeine-sleep-arrhythmia-safety-2026.png'
    Title = '에너지드링크'
    Subtitle = '카페인 · 수면손실 · 두근거림'
    Chips = @('카페인', '수면', '심박')
  },
  @{
    Source = 'slow-aging-blood-sugar-spike-marine-polyphenol-2026.png'
    Output = 'berberine-blood-sugar-supplement-drug-interaction-safety-2026.png'
    Title = '베르베린 안전'
    Subtitle = '혈당 · 약물상호작용 · 보충제 품질'
    Chips = @('베르베린', '혈당', '상담')
  }
)
