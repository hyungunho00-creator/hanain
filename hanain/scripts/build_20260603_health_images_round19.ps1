...
$items = @(
  @{
    ...
    Output = 'pickleball-overuse-achilles-wrist-injury-prevention-record-2026.png'
    Title = S '7ZS87YG067O8IOu2gOyDgSDqsr3rs7Q='
    Subtitle = S '7IaQ66qpwrfslYTtgqzroIjsiqQg6riw66Gd'
    Chips = @((S '7ZS87YG067O8'), (S '7IaQ66qp'), (S '7JWE7YKs66CI7Iqk'))
  },
  @{
    Source = 'youth-mental-health-sleep-screen-time-record-2026.png'
    Output = 'teen-social-media-sleep-mental-health-boundary-record-2026.png'
    Title = S '7IaM7IWc66+465SU7Ja0IOyImOuptCDqsr3qs4Q='
    Subtitle = S '7LKt7IaM64WEIOygleyLoOqxtOqwlSDquLDroZ0='
    Chips = @((S '7IiY66m0'), (S 'U05T'), (S '6rK96rOE'))
  },
  @{
    Source = 'glp1-plateau-muscle-protein-fiber-record-2026.png'
    Output = 'glp1-compounded-dosing-error-gi-side-effect-record-2026.png'
    Title = S 'R0xQLTEg7JyE7J6l6rSAIOqyveuztA=='
    Subtitle = S '67O17ZWp7KGw7KCcwrfsmqnrn4kg6riw66Gd'
    Chips = @((S 'R0xQLTE='), (S '6rWs7Yag'), (S '7YOI7IiY'))
  }
)
...
foreach ($item in $items) {
  ...
  Draw-RoundedRect $g (New-Brush 252 255 255 255) 70 66 800 502 28
