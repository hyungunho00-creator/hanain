...
$items = @(
  @{
    ...
    Output = 'exosome-scalp-injection-hair-loss-fda-safety-record-2026.png'
    Title = S '7JeR7IaM7KKAIOuRkO2UvOyjvOyCrCDqsr3rs7Q='
    Subtitle = S '7YOI66qoIOq0keqzoCDquLDroZ0='
    Chips = @((S '7JeR7IaM7KKA'), (S '65GQ7ZS8'), (S '6rSR6rOg'))
  },
  @{
    Source = 'hpv-self-collection-cervical-screening-home-test-record-2026.png'
    Output = 'dense-breast-mammogram-notification-supplemental-screening-record-2026.png'
    Title = S '7LmY67CA7Jyg67CpIOyVjOumvA=='
    Subtitle = S '66eY66qo6re4656oIOy2lOqwgOqygOyCrCDquLDroZ0='
    Chips = @((S '7LmY67CA7Jyg67Cp'), (S '6rKA7KeE'), (S '7IOB64u0'))
  },
  @{
    Source = 'testosterone-therapy-low-libido-blood-pressure-monitoring-2026.png'
    Output = 'testosterone-therapy-fertility-sperm-count-record-2026.png'
    Title = S 'VFJUIOyehOyLoOqzhO2ajSDqsr3rs7Q='
    Subtitle = S '7KCV7J6Q7IiYwrftmLjrpbTrqqwg6riw66Gd'
    Chips = @((S 'VFJU'), (S '7KCV7J6Q7IiY'), (S '7J6E7Iug6rOE7ZqN'))
  }
)
...
foreach ($item in $items) {
  ...
  Draw-RoundedRect $g (New-Brush 252 255 255 255) 70 66 815 502 28
