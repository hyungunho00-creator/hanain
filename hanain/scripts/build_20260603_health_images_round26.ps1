...
$items = @(
  @{
    Source = 'weighted-vest-rucking-bone-joint-safety-record-2026.png'
    Output = 'older-adult-fall-prevention-balance-medication-vision-record-2026.png'
    Title = S '64KZ7IOBwrfqs6DqtIDsoIgg6rOo7KCIIOyYiOuwqSDquLDroZ0='
    Subtitle = S '6reg7ZiVwrfsi5zroKXCt+yVveusvCDsg4Hri7Q='
    Chips = @((S '64KZ7IOB'), (S '6reg7ZiV'), (S '6riw66Gd'))
  },
  @{
    Source = 'psychological-self-help-digital-burnout-support-record-2026.png'
    Output = 'loneliness-social-connection-health-risk-support-record-2026.png'
    Title = S '7Jm466Gc7JuAwrfsgqztmozsoIEg7Jew6rKwIOqxtOqwlSDquLDroZ0='
    Subtitle = S '6rSA6rOEwrfsiJjrqbTCt+ychOq4sCDsi6DtmLgg7IOB64u0'
    Chips = @((S '7Jew6rKw'), (S '7Jm466Gc7JuA'), (S '7KeA7JuQ'))
  },
  @{
    Source = 'masld-fatty-liver-insulin-resistance-phlorotannin-2026.png'
    Output = 'masld-fib4-liver-fibrosis-risk-stratification-record-2026.png'
    Title = S 'TUFTTEQgRklCLTQg6rCE7ISs7Jyg7ZmUIOq4sOuhnQ=='
    Subtitle = S '7ZeI66as65GY66CIwrftmIjri7nCt+qwhOyImOy5mCDsg4Hri7Q='
    Chips = @((S 'TUFTTEQ='), (S 'RklCLTQ='), (S '6rCE6rG06rCV'))
  }
)
