...
$items = @(
  @{
    Source = 'rsv-vaccine-older-adults-risk-record-2026.png'
    Output = 'respiratory-virus-vaccine-2025-2026-covid-flu-rsv-record-2026.png'
    Title = S 'MjAyNS0yNiDtmLjtnaHquLAg67Cx7IugIOq4sOuhnQ=='
    Subtitle = S '7L2U66Gc64KYwrfrj4XqsJDCt1JTViDsg4Hri7Q='
    Chips = @((S '7Zi47Z2h6riw'), (S '67Cx7Iug'), (S '7IOB64u0'))
  },
  @{
    Source = 'norovirus-handwashing-bleach-hydration-outbreak-record-2026.png'
    Output = 'candida-auris-hospital-infection-antifungal-resistance-record-2026.png'
    Title = S '7Lm465SU64ukIOyVhOyasOumrOyKpCDqsJDsl7zqtIDrpqw='
    Subtitle = S '67OR7JuQIOqwkOyXvOqzvCDrgrTshLEg6riw66Gd'
    Chips = @((S 'Qy4gYXVyaXM='), (S '64K07ISx'), (S '67OR7JuQ6rCQ7Je8'))
  },
  @{
    Source = 'melasma-tinted-sunscreen-visible-light-iron-oxide-record-2026.png'
    Output = 'home-led-red-light-mask-fda-cleared-skin-safety-record-2026.png'
    Title = S '7ZmIIExFRCDrp4jsiqTtgawg7JWI7KCEIOq4sOuhnQ=='
    Subtitle = S 'RkRBIGNsZWFyZWQg7ZmV7J24'
    Chips = @((S 'TEVE66eI7Iqk7YGs'), (S '66CI65Oc65287J207Yq4'), (S '7ZS867aA'))
  }
)
...
$titleFont = New-Object System.Drawing.Font($fontFamily, 39, [System.Drawing.FontStyle]::Bold)
