...
$items = @(
  @{
    ...
    Output = 'indoor-co2-ventilation-hepa-respiratory-virus-record-2026.png'
    Title = S '7Iuk64K06rO16riwIO2ZleyduA=='
    Subtitle = S 'Q08yIMK3IO2ZmOq4sCDCtyBIRVBBIOq4sOuhnQ=='
    Chips = @((S '7Zi47Z2h6riw'), (S '7ZmY6riw'), (S '6riw66Gd'))
  },
  @{
    Source = 'h5n1-bird-flu-raw-milk-exposure-monitoring-record-2026.png'
    Output = 'norovirus-handwashing-bleach-hydration-outbreak-record-2026.png'
    Title = S '64W466Gc67CU7J2065+s7IqkIOuMgOydkQ=='
    Subtitle = S '7IaQ7JS76riwIMK3IO2RnOuptOyGjOuPhSDCtyDsiJjrtoTrs7Tstqk='
    Chips = @((S '6rCQ7Je8'), (S '7IaQ7JS76riw'), (S '7IaM64+F'))
  },
  @{
    Source = 'diet-microbiome-ibs-upf-fermented-food-record-2026.png'
    Output = 'fermented-food-probiotics-gut-microbiome-safety-record-2026.png'
    Title = S '67Cc7Zqo7Iud7ZKIIOq1rOu2hA=='
    Subtitle = S '7ZSE66Gc67CU7J207Jik7Yux7IqkIMK3IOyepeqxtOqwlSDCtyDslYjsoITshLE='
    Chips = @((S '67Cc7Zqo'), (S '7J6l6rG06rCV'), (S '7JWI7KCE'))
  }
)
