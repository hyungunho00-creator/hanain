...
$items = @(
  @{
    Source = 'cleaner-indoor-air-respiratory-virus-ventilation-record-2026.png'
    Output = 'pollen-thunderstorm-asthma-action-plan-record-2026.png'
    Title = S '6r2D6rCA66OoIOyynOyLnSDqsr3rs7Q='
    Subtitle = S '7LKc7IudIO2WieuPmeqzhO2ajQ=='
    Chips = @((S '6r2D6rCA66Oo'), (S '7LKc7Iud'), (S '7Z2h7J6F6riw'))
  },
  @{
    Source = 'h5n1-bird-flu-raw-milk-exposure-monitoring-record-2026.png'
    Output = 'tick-bite-lyme-alpha-gal-syndrome-summer-record-2026.png'
    Title = S '7KeE65Oc6riwIOusvOumvCDqsr3rs7Q='
    Subtitle = S '65287J6E67ORwrfslYztjIzqsIgg6riw66Gd'
    Chips = @((S '7KeE65Oc6riw'), (S '67Cc7KeE'), (S '7JWM66CI66W06riw'))
  },
  @{
    Source = 'sunscreen-vitamin-d-uv-index-myth-check-2026.png'
    Output = 'melasma-tinted-sunscreen-visible-light-iron-oxide-record-2026.png'
    Title = S '6riw66+4IOyEoOyKpO2BrOumsCDshKDtg50='
    Subtitle = S '7Yu07Yuw65OcwrfssqDsgrDtmZTrrLwg6riw66Gd'
    Chips = @((S '6riw66+4'), (S 'U1BG'), (S '7LKg7IKw7ZmU66y8'))
  }
)
