...
$items = @(
  @{
    ...
    Output = 'tight-hairstyle-traction-alopecia-hairline-record-2026.png'
    Kicker = 'HAIRLINE RECORD'
    Title = @('꽉 묶는 머리', '헤어라인 기록')
    Subtitle = '당김·통증·빈 부위 변화 확인'
    Chips = @('견인성탈모', '헤어라인', '두피')
  ...
  @{
    ...
    Output = 'testicular-lump-young-men-self-check-record-2026.png'
    Kicker = 'MEN HEALTH RECORD'
    Title = @('고환 덩이', '변화 기록')
    Subtitle = '크기·통증·가족력 빠른 상담'
    Chips = @('남성건강', '고환', '상담')
    Accent = [System.Drawing.Color]::FromArgb(42, 74, 126)
  },
  @{
    Source = 'summer-uti-women-hydration-urination-symptom-record-2026.png'
    Output = 'pregnancy-postpartum-warning-signs-blood-pressure-record-2026.png'
    Kicker = 'POSTPARTUM WARNING'
    Title = @('출산 후 두통', '혈압 기록')
    Subtitle = '시야 흐림·부종·호흡곤란 확인'
    Chips = @('여성건강', '산후', '혈압')
