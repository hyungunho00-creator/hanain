...
$items = @(
  @{
    ...
    Output = 'sleep-regularity-circadian-heart-risk-record-2026.png'
    Title = '수면 규칙성'
    Subtitle = '취침 시간 · 심혈관 · 생활 리듬'
    Chips = @('수면', '리듬', '심혈관')
  },
  @{
    Source = 'skin-barrier-photoaging-phlorotannin-polyphenol-2026.png'
    Output = 'vitamin-d-sun-exposure-sunscreen-skin-balance-2026.png'
    Title = '비타민D와 햇빛'
    Subtitle = '자외선 차단 · 피부 · 근육 기능'
    Chips = @('비타민D', '햇빛', '피부')
  },
  @{
    Source = 'fiber-gut-microbiome-polyphenol-phlorotannin-2026.png'
    Output = 'coffee-gut-brain-axis-polyphenol-microbiome-2026.png'
    Title = '커피와 장-뇌축'
    Subtitle = '폴리페놀 · 기분 · 장내미생물'
    Chips = @('커피', '폴리페놀', '장건강')
  }
)
