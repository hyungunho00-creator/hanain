...
$items = @(
  @{
    ...
    Output = 'cgm-prediabetes-a1c-postprandial-spike-record-2026.png'
    Title = '식후혈당 기록'
    Subtitle = 'CGM · A1C · 전당뇨 확인'
    Chips = @('CGM', 'A1C', '식후')
  },
  @{
    Source = 'resistant-starch-gut-microbiome-polyphenol-phlorotannin-2026.png'
    Output = 'diet-microbiome-ibs-upf-fermented-food-record-2026.png'
    Title = '장내미생물 식단'
    Subtitle = 'IBS · 발효식품 · 증상 기록'
    Chips = @('장건강', 'IBS', '식단')
  },
  @{
    Source = 'wearable-vo2max-cardio-fitness-longevity-record-2026.png'
    Output = 'dyslipidemia-prevent-ldl-apob-lpa-risk-record-2026.png'
    Title = '콜레스테롤 위험평가'
    Subtitle = 'LDL · ApoB · PREVENT'
    Chips = @('LDL', 'ApoB', '위험')
  }
)
